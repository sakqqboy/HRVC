		...
		<thead>
			<tr class="pim-table-header text-center">
				...
				<th style="border-top-right-radius: 4px;border-bottom-right-radius: 4px;">
					<a class="btn-create font-size-12 text-center no-underline" id="editRelateKgi" style="padding-left: 10px;padding-right:10px;" href="javascript:showEditRelateKgi(1,<?= $kfiId ?>)">Edit</a>
					<a class="btn-create font-size-12 text-center no-underline" id="saveRelateKgi" style="padding-left: 10px;padding-right:10px;display:none;" href="javascript:showEditRelateKgi(0,<?= $kfiId ?>)">Save</a>
				</th>
			</tr>
		</thead>
		<tbody>
