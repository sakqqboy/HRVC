	...
	<div class="col-12 mt-10">
		...
		<div class="alert mt-10 pim-body bg-white">
			<div class="row">
				...
				<div class="col-1">
					<a class="btn btn-bg-red-xs" data-bs-toggle="modal" data-bs-target="#delete-kfi" onclick="javascript:prepareDeleteKfi(<?= $kfiId ?>)">Delete
			...
			<div class="row mt-10">
						...
						<div class="row">
							<div class="col-lg-4 pim-subheader-font border-right-<?= $colorFormat ?> pl-18">
								...
								<div class="col-12 border-bottom-<?= $colorFormat ?> pb-5 pim-duedate">
									<i class="fa fa-diamond" aria-hidden="true"></i> <?= $kfiDetail["quantRatio"] == 1 ? 'Quantity' : 'Quality' ?>
								</div>
							...
							<div class="col-lg-8 pim-subheader-font pr-15 pl-15">
								<div class="row">
									...
									<div class="col-4 mt-5 pl-0 pr-0 ">
										...
										<div class="col-12 text-start pim-duedate"><?= $kfiDetail['nextCheck'] == "" ? 'Not set' : $kfiDetail['nextCheck'] ?></div>
									</div>
									<div class="col-4 text-center mt-5 pt-6 pl-3 pr-3">
										<?php
										if ($role > 3  && $kfiDetail["status"] == 1) {
										?>
											<div onclick="javascript:updateKfi(<?= $kfiId ?>)" class="pim-btn-<?= $colorFormat ?>" data-bs-toggle="modal" data-bs-target="#update-kfi-modal">
									...
									<div class="col-4 pl-0 pr-5 mt-5 ">
										...
										<div class="col-12 text-end pim-duedate"><?= $kfiDetail['nextCheck'] == "" ? 'Not set' : $kfiDetail['nextCheck'] ?></div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-7">
					<div class="row">
						...
						<div class="col-3  view-tab" id="tab-4" onclick="javascript:viewTabKfi(4)">
