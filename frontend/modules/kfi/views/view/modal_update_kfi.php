<div class="modal fade" id="update-kfi-modal" tabindex="-1" aria-labelledby="staticBackdrop2" aria-hidden="true">
						...
						<div class="row">
							...
							<div class="col-lg-8 col-md-6 col-6 pt-10  mt-17">
								...
								<select class="form-select font-size-13" id="code" name="code" required>
									...
									<option value="<">&nbsp;&nbsp;<?= '<' ?>&nbsp;&nbsp;<?= Yii::t('app', 'Result more than targe') ?>t</option>
