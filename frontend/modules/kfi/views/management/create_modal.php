			...
			<div class="modal-body">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-6">
						<div class="col-12">
							<label class="form-label font-size-12"><strong class="red">*</strong> <?= Yii::t('app', 'KFI Contents') ?></label>
							<input type="text" class="form-control" id="" name="kfiName" required>
						</div>
						<div class="col-12 pt-5">
							<label class="form-label font-size-12"><strong class="red">*</strong> <?= Yii::t('app', 'Company') ?></label>
						...
						<div class="col-12 mt-10">
							<label for="input" class="form-label font-size-12"><strong class="red">*</strong> <?= Yii::t('app', 'Branch') ?></label>
						...
						<div class="col-12 mt-10">
							<label for="input" class="form-label font-size-12"><strong class="red">*</strong> <?= Yii::t('app', 'Department') ?></label>
							<div class="col-12 form-control">
						...
						<div class="col-12 pt-10">
							<label for="input" class="form-label font-size-12"><strong class="red">*</strong> <?= Yii::t('app', 'Check Unit') ?></label>
						...
						<div class="col-lg-12 col-md-6 col-12 mt-10">
							<div class="input-group">
								<label for="input" class="form-label font-size-12"><strong class="red">*</strong> <?= Yii::t('app', 'Next Check Date') ?></label>
								<div class="input-group">
									<span class="input-group-text font-size-12"><i class="fa fa-calendar-o" aria-hidden="true"></i> &nbsp;&nbsp; <?= Yii::t('app', 'Date') ?></span>
					...
					<div class="col-lg-6 col-md-6 col-6">
						...
						<div class="row">
							...
							<div class="col-12 pt-10">
								<label class="form-label font-size-12"><strong class="red">*</strong> <?= Yii::t('app', 'Target Amount') ?></label>
								<input type="number" class="form-control" name="amount" step="any" required>
							</div>
							<div class="col-lg-6 col-md-6 col-6 pt-10">
								<label class="form-label font-size-12"><strong class="red">*</strong> <?= Yii::t('app', 'Month') ?></label>
