...
<div class="row mt-10">
    <div class="col-2  text-end border-bottom pb-10">
        <input class="checkbox-lg" id="assign-branch-kfi-<?= $kfiId ?>-<?= $branch['branchId'] ?>"
            onchange="javascript:assignKfiBranch(<?= $kfiId ?>,<?= $branch['branchId'] ?>)" type="checkbox"
            value="<?= $branch['branchId'] ?>" <?= $isCheck == 1 ? 'checked' : '' ?>>
    </div>
