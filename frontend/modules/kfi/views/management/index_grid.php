                                        ...
                                        <div class="col-12 mt-18">
                                            <div class="row">
                                                <div class="col-6 border-right-<?= $colorFormat ?>">
                                                    <div class="col-12  pr-6 pt-10 text-center"><?= Yii::t('app', 'Quant Ratio') ?></div>
                                                ...
                                                <div class="col-6">
                                                    <div class="col-12 pr-0 pt-10 text-center"><?= Yii::t('app', 'Update Interval') ?>
                                                    </div>
                                                    <div class="col-12 pim-duedate text-center mt-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-5 pl-5 pr-5 mt-10 ">
                                                ...
                                                <div class="col-12 text-end pim-duedate">
                                                    <?= $kfi['nextCheck'] == "" ? Yii::t('app', 'Not set') : $kfi['nextCheck'] ?></div>
                                            </div>
