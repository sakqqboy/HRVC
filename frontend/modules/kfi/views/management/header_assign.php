<div class="alert alert2-secondary2">
	<ul class="nav nav-pills " id="pills-tab" role="tablist">
		<li class="nav-item" role="presentation">
			<a href="<?= Yii::$app->homeUrl ?>kfi/management/assign-kfi" class="nav-link text-dark active" id="pills-Financial-tab" type="button" role="tab" aria-controls="pills-Financial" aria-selected="true">
		...
		<li class="nav-item" role="presentation">
			<a href="<?= Yii::$app->homeUrl ?>kpi/management/assign-kpi" class="nav-link text-dark" id="pills-Performance-tab" type="button" role="tab" aria-controls="pills-Performance" aria-selected="false">
		...
		<li class="nav-item presentation-end" role="presentation">
			<a href="<?= Yii::$app->homeUrl ?>kfi/management/index"> <span class="pl-20 pr-20 badge bg kfi-assignpage text-end" type="submit"> <?= Yii::t('app', 'KFI') ?> </span></a>
		</li>
