<div class="modal fade" id="kfi-issue" tabindex="-1" aria-labelledby="exampleModalfirstoneLabel" aria-hidden="true">
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			<div class="modal-header" style="border-bottom:none;">
				<div class="modal-title Modalfirstone" id="exampleModalfirstoneLabel">
					<i class="fa fa-line-chart" aria-hidden="true"></i> <span id="kfi-name-issue">
				</div>
			...
			<div class="modal-body">
				...
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane fade show active" id="pills-Issues" role="tabpanel" aria-labelledby="pills-Issues-tab-kfi">

					</div>
					<div class="tab-pane fade" id="pills-History" role="tabpanel" aria-labelledby="pills-History-tab-kfi">
