            ...
            <div class="col-12 bg-white border-bottom">
                <div class="row">
                    ...
                    <div class="col-3 font-size-12 text-center pt-5">
                        <input type="text" name="employeeTarget[<?= $employeeId ?>]" class="assign-target text-end input-<?= $teamId ?>-<?= $i ?>"
                    ...
                    <div class="col-4 font-size-12 text-center pt-5">
                        <textarea type="text" class="assign-target input-<?= $teamId ?>-<?= $i + 1 ?>" name="employeeRemark[<?= $employeeId ?>]"
                            style="height: 30px;" onkeydown="javascript:checkEnterTextArea(event,<?= $employeeId ?>,<?= $teamId ?>,<?= $i + 1 ?>)"></textarea>
                    </div>
                </div>
            </div>
    <?php
