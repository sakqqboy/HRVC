	...
	<div class="row header-filter-pim">
		<div class="col-10 pt-13 pb-5 pl-0">
			<div class="row">
				...
				<div class="col-3 border-right text-center">
					<a href="<?= Yii::$app->homeUrl ?>kgi/management/grid" class="header-kgi-active">
						<span>
		...
		<div class="col-2 text-end">
			<!-- <div class="col-12 pt-13">
				...
				//if ($role >= 3) {
				?>
					<a href="<?= Yii::$app->homeUrl ?>kgi/management/wait-approve" class="nav-link text-dark" id="pills-Setting-tab" type="button" role="tab" aria-controls="pills-Action" aria-selected="false">
