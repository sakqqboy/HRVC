                ...
                <div class="row mt-10">
                    <div class="col-lg-7 col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-4 month-<?= $colorFormat ?> pt-2"><?= $kgiTeamDetail['monthName'] ?></div>
                    ...
                    <div class="col-lg-7">
                        <div class="row">
                            <div class="col-2  view-tab-active" id="tab-1" onclick="javascript:viewTabTeamKgi(<?= $kgiTeamHistoryId ?>,1,<?= $kgiId ?>,<?= $kgiTeamId ?>)">
                            ...
                            <div class="col-3  view-tab" id="tab-2" onclick="javascript:viewTabTeamKgi(<?= $kgiTeamHistoryId ?>,2,<?= $kgiId ?>,<?= $kgiTeamId ?>)">
                            ...
                            <div class="col-2  view-tab" id="tab-3" onclick="javascript:viewTabTeamKgi(<?= $kgiTeamHistoryId ?>,3,<?= $kgiId ?>,<?= $kgiTeamId ?>)">
                            ...
                            <div class="col-2  view-tab" id="tab-4" onclick="javascript:viewTabTeamKgi(<?= $kgiTeamHistoryId ?>,4,<?= $kgiId ?>,<?= $kgiTeamId ?>)">
                            ...
                            <div class="col-3  view-tab" id="tab-5" onclick="javascript:viewTabTeamKgi(<?= $kgiTeamHistoryId ?>,5,<?= $kgiId ?>,<?= $kgiTeamId ?>)">
...
<script>
    window.onload = function() {
        ...
        if (openTab) {
            viewTabTeamKgi(<?= $kgiTeamHistoryId ?>, openTab, <?= $kgiId ?>, <?= $kgiTeamId ?>); // Set the tab based on the PHP value
        } else {
            viewTabTeamKgi(<?= $kgiTeamHistoryId ?>, 1, <?= $kgiId ?>, <?= $kgiTeamId ?>); // Default to tab 1 if no value is passed
        }
    }
</script>