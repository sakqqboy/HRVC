			...
			<div class="row">
										...
										<div class="col-12 approval-box text-center pr-3">
											...
											?>
												<a href="<?= Yii::$app->homeUrl ?>kgi/management/wait-approve" style="text-decoration: none;color:#2580D3;">
													...
													Approvals
													<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/approve.svg" class="first-layer-icon pull-right" style="margin-top:-2px;">
												</a>
											<?php
											} else { ?>
				...
				<div class="col-lg-1 col-md-6 col-12 pr-0 text-end">
					<div class="btn-group" role="group">
						<a href="<?= Yii::$app->homeUrl ?>kgi/kgi-team/team-kgi-grid" class="btn btn-primary font-size-12 pim-change-mode">
							<i class="fa fa-th-large" aria-hidden="true"></i>
						</a>
						<a href="<?= Yii::$app->homeUrl ?>kgi/kgi-team/team-kgi" class="btn btn-outline-primary font-size-12 pim-change-mode">
							...
							<div class="col-12 mt-10 mb-5 pim-big-box pim-<?= $colorFormat ?>" id="kgi-team-<?= $kgiTeamId ?>">
								<div class="row">
									...
									<div class="col-lg-5 col-md-2 col-4 text-end pr-20">
										...
										<a class="btn btn-bg-white-xs mr-5" data-bs-toggle="modal" data-bs-target="#staticBackdrop3" onclick="javascript:kgiHistory(<?= $kgiTeamId ?>)" style="margin-top: -3px;">
											<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/chart.png" alt="History" class="pim-icon mr-3" style="margin-top: -2px;">Chart
										</a>
										<?php
										if ($role >= 5) {
										?>
											<a class="btn btn-bg-red-xs" data-bs-toggle="modal" data-bs-target="#delete-kgi-team" onclick="javascript:prepareDeleteKgiTeam(<?= $kgiTeamId ?>)" style="margin-top: -3px;">
												...
												<div class="col-12 <?= $colorFormat ?>-assign  mt-5 pt-2 pb-2">
													<div class="row">
														<div class="col-5 border-right-<?= $colorFormat ?> pr-2">
															<div class="row">
																<div class="col-2">
																	...
																	?>
																		<img src="<?= Yii::$app->homeUrl . $kgi['kgiEmployeeSelect'][0] ?>" class="pim-pic-grid">
																	<?php
																	}
																	?>
																</div>
																<div class="col-2 pic-after pt-0">
																	...
																	?>
																		<img src="<?= Yii::$app->homeUrl . $kgi['kgiEmployeeSelect'][1] ?>" class="pim-pic-grid">
																	<?php
																	}
																	?>
																</div>
																<div class="col-2 pic-after pt-0">
																	...
																	?>
																		<img src="<?= Yii::$app->homeUrl . $kgi['kgiEmployeeSelect'][2] ?>" class="pim-pic-grid">
																	<?php
																	}
																	?>
																</div>
														...
														<div class="col-7 pl-3 pr-13 pt-1">
															...
															if ($role >= 3) {
															?>
																<a href="<?= Yii::$app->homeUrl ?>kgi/assign/assign/<?= ModelMaster::encodeParams(['kgiId' => $kgi["kgiId"], "companyId" => $kgi["companyId"]]) ?>" class="font-<?= $colorFormat ?>">
																	Assign Teammate
																</a>
															<?php
															} else { ?>
									...
									<div class="col-lg-3 pim-subheader-font border-right-<?= $colorFormat ?>  pr-15 pl-15 mt-5">
										<div class="row">
											...
											<div class="col-4 pl-5 pr-5 mt-10">
												...
												<div class="col-12 text-start pim-duedate"><?= $kgi['nextCheckDate'] == "" ? 'Not set' : $kgi['nextCheckDate'] ?></div>
											</div>
											...
											<div class="col-4 pl-0 pr-5 mt-10">
												...
												<div class="col-12 text-end pim-duedate"><?= $kgi['nextCheckDate'] == "" ? 'Not set' : $kgi['nextCheckDate'] ?></div>
											</div>
										</div>
									</div>
