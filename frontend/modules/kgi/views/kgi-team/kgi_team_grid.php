    ...
    <div class="col-12 mt-20" id="box-wrapper">
        <div class="bg-white-employee" id="pim-content">
            ...
            <div class="row mt-20 pl-10 pr-10 pim-content mb-10" style="--bs-gutter-x:0px;" id="main-body">
                ...
                ?>
                        <div class="col-12 mb-25 pim-big-box pim-<?= $colorFormat ?>" id="kgi-<?= $kgiTeamId ?>">
                                                ...
                                                <div class="col-4 text-center align-content-center">
                                                    ...
                                                    ?>
                                                        <a href="<?= Yii::$app->homeUrl . 'kgi/kgi-team/prepare-update/' . ModelMaster::encodeParams(['kgiTeamId' => $kgiTeamId]) ?>"
                                                            class="pim-btn-setup">
                                                            <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/setupwhite.svg" class="mr-3" style="width: 10.42px; height: 10.53px;">
                                                            <?= Yii::t('app', 'Setup') ?>
                                                        </a>
                                                    <?php
