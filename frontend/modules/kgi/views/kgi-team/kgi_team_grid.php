...
<div class="col-12 mt-70">
	...
	<div class="col-12 mt-10">
					...
					<div class="row">
						<div class="col-12 new-light-4">
							<div class="btn-group" role="group" aria-label="Basic example">
								<a href="<?= Yii::$app->homeUrl ?>kgi/kgi-team/team-kgi" class="btn btn-outline-primary font-size-13"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
								<a href="<?= Yii::$app->homeUrl ?>kgi/kgi-team/team-kgi-grid" class="btn  btn-primary font-size-13"><i class="fa fa-th-large" aria-hidden="true"></i></a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="card example-5 scrollbar-ripe-malinka">
			...
			?>
					<div class="col-12 kgi-grid-box <?= $class ?> " id="kgi-team-<?= $kgiTeamId ?>">
						<div class="row">
								...
								<div class="row">
									<div class="col-5 text-end">
										...
										<span class="badge rounded-pill bg-bsc font-size-10">
											<i class="fa fa-users" aria-hidden="true"></i> <?= $kgi["teamName"] ?>
										</span>
									</div>
									<div class="col-5">
										<div class="row">
									...
									<div class="col-lg-2 col-md-6 col-12 text-end">
										<button class="btn btn-sm btn-outline-secondary font-size-10" data-bs-toggle="modal" data-bs-target="#kgi-view-team" onclick="javascript:kgiTeamHistory(<?= $kgiTeamId ?>)">
											<i class="fa fa-eye" aria-hidden="true"></i>
										</button>
										<?php
										if ($role >= 4) {
										?>
											<button class="btn btn-sm btn-outline-danger font-size-10" data-bs-toggle="modal" data-bs-target="#delete-kgi-team" onclick="javascript:prepareDeleteKgiTeam(<?= $kgiTeamId ?>)">
									...
									<div class="col-md-6">
										<div class="row">
											...
											<div class="col-12 font-size-10 font-b text-end">
												...
												if ($canEdit == 1) {
												?>
													<span class="pencil-nextupdate text-center ml-3" data-bs-toggle="modal" data-bs-target="#update-kgi-modal-team" onclick="javascript:updateTeamKgi(<?= $kgiTeamId ?>)">
