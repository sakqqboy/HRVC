...
<div class="row">
    ...
    <div class="col-2 pr-5 pl-1">
        <select class="form-select font-size-12 <?= $teamId != "" ? 'select-pimselect' : 'select-pim' ?>"
            id="team-filter" <?= $branchId == "" ? 'disabled' : '' ?>
    ...
    <div class="col-2 pr-5 pl-1">
        <select class="form-select font-size-12 <?= $year != '' ? 'select-pimselect' : 'select-pim' ?>"
    ...
    <div class="col-1 pr-5 pl-1">
        <select class="form-select font-size-12 <?= $status != "" ? 'select-pimselect' : 'select-pim' ?>" id="status-filter"
            ...
            if (isset($status) && $status != "") { ?>
                <option value="<?= $status ?>"><?= $status == 1 ?  Yii::t('app', 'Active') : Yii::t('app', 'inished') ?></option>
            <?php
            }
            ?>
    ...
    <div class="col-1 pl-0">
        <span class="btn font-size-12 justify-content-center d-flex align-items-center custom-button-select"
            ...
            <img src="<?= Yii::$app->homeUrl ?>images/icons/Dark/48px/FilterWhite.svg" class="pim-search-icons me-2"
                style=" cursor: pointer;" onclick="javascript:kgiFilterForTeam()">
            <?= Yii::t('app', 'Filter') ?>
        </span>
    </div>
</div>
