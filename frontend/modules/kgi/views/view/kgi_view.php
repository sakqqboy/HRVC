								...
								<div class="col-12 mt-10 mb-5 pim-big-box pim-<?= $colorFormat ?> pt-3 pl-15">
									<div class="row">
										...
										<div class="col-7 text-end">
											...
											?>
												<a class="btn btn-bg-white-xs pr-2 pl-3" onclick="javascript:prepareKgiNextTarget(<?= $kgi['kgiHistoryId'] ?>)">
													<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/copy.png" alt="History" class="home-icon">
												</a>
											<?php
											}
											?>
											<a class="btn btn-bg-white-xs" data-bs-toggle="modal" data-bs-target="#staticBackdrop3" onclick="javascript:kgiHistory(<?= $kgi['kgiHistoryId'] ?>)">
											...
											<a href="<?= Yii::$app->homeUrl ?>kgi/view/index/<?= ModelMaster::encodeParams(["kgiHistoryId" => $kgi['kgiHistoryId']]) ?>" class="btn btn-bg-white-xs">
										...
										<div class="col-3 font-size-10 pt-15">
											...
											<div class="col-12 font-size-9 border-bottom pb-3">
												<i class="fa fa-diamond" aria-hidden="true"></i><b><?= $kgi["quantRatio"] == 1 ? 'Quantity' : 'Quality' ?></b>
											</div>
