<div class="modal fade" id="update-kgi-modal" tabindex="-1" aria-labelledby="staticBackdropLabel2" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-6 font-size-14">
                        <div class="col-12">
                            <label for="exampleFormControlInput1" class="form-label"><strong class="red">*</strong>KGI
                                Contents</label>
                            <input type="text" class="form-control" id="kgiName-update" name="kgiName">
                        </div>
                        ...
                        <div class="col-12 mt-10">
                            <label for="exampleFormControl" class="form-label font-size-13"> Title Progress</label>
                        ...
                        <div class="row mt-15">
                            ...
                            <div class="col-12 mt-10">
                                <div class="input-group">
                                    <label for="input" class="form-label"><strong class="red">*</strong> Next Check
                                        Date</label>
                                    <div class="input-group">
                    ...
                    <div class="col-lg-6 col-md-6 col-6">
                        <div class="col-12">
                            <label for="exampleFormControlTextarea1" class="form-label font-size-13"> KGI
                                Details</label>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-6 pt-10">
                                <label for="exampleFormControl" class="form-label font-size-13"><strong
                                        class="red">*</strong> Quant Ratio</label>
                            ...
                            <div class="col-lg-6 col-md-6 col-6 pt-10">
                                <label for="exampleFormControl" class="form-label font-size-13"><strong
                                        class="red">*</strong> Priority</label>
                                <select class="form-select font-size-13" aria-label="Default select example"
                            ...
                            <div class="col-lg-4 col-md-6 col-6 pt-10">
                                <label for="exampleFormControl" class="form-label font-size-13"><strong
                                        class="red">*</strong> Amount Type</label>
                                <select class="form-select font-size-13" aria-label="Default select example"
                                    name="amountType" id="amountType-update" required>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 pt-10">
                                ...
                                <select class="form-select font-size-13" aria-label="Default select example"
                                    name="status" id="status-update" required>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 pt-10">
                                ...
                                <select class="form-select font-size-13" aria-label="Default select example"
                                    name="month" id="month-update" required>
                            ...
                            <div class="col-12 mt-10">
                                ...
                                <input type="text" class="form-control text-end font-size-13" name="result"
                                    id="result-update">
                            </div>
            ...
            <div class="modal-footer" style="border: none;">
                ...
                <a href="javascript:checkRequiredUpdate()" class="btn btn-warning">Update</a>
            </div>
        </div>
    </div>
    <input type="hidden" id="kgiId" name="kgiId" value="">
</div>