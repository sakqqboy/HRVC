	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="col-6 text-start font-b font-size-18 pl-15" style="margin-top: -35px;">
				<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/warning.png" alt="History" class="home-icon mr-5" style="margin-top:-7px;">
				Copy Notice
			</div>
			<div class="modal-body">

				<div class="col-12 text-start">
					When copying PIM content, all existing values be carried forward to the next month, except for the results. To update the target, please make
					the necessary adjustment on the 'Assign Employee' page.
				</div>
			</div>
			<div class="col-12 text-end mt-20 pr-10 pb-10">
				<input type="hidden" id="kgiEmployeeHistoryId" value="">
				<button type="button" class="btn btn-danger mr-10 btn-sm" data-bs-dismiss="modal">Cancel</button>
				<a href="javascript:kgiEmployeeNextTarget()" class="btn btn-primary btn-sm">Copy
