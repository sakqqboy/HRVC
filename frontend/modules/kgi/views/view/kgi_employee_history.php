			...
			<div class="col-12">
				<div class="row">
					<div class="col-6 font-size-12 pim-name pr-0 pl-5 text-start">
						<a href="<?= Yii::$app->homeUrl ?>kgi/kgi-personal/individual-kgi-grid" class="mr-5 font-size-12">
								...
								<div class="col-12 mt-10 mb-5 pim-big-box pim-<?= $colorFormat ?> pt-3 pl-15">
									<div class="row">
										...
										<div class="col-7 text-end">
											...
											if ($i == 0 && $kgi["status"] == 2) {
											?>
												<a class="btn btn-bg-white-xs pr-2 pl-3" onclick="javascript:prepareKgiEmployeeNextTarget(<?= $kgi['kgiEmployeeHistoryId'] ?>)">
													<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/copy.png" alt="History" class="home-icon">
												</a>
											<?php
											}
											?>
											<a class="btn btn-bg-white-xs" data-bs-toggle="modal" data-bs-target="#staticBackdrop3" onclick="javascript:kgiHistory(<?= $kgi['kgiEmployeeHistoryId'] ?>)">
											...
											<div class="row">
												<div class="col-lg-6">
													...
													<div class="col-12 font-size-9 text-center mt-1">
														<i class="fa fa-diamond mr-2" aria-hidden="true"></i><b><?= $kgi["quantRatio"] == 1 ? 'Quantity' : 'Quality' ?></b>
													</div>
												</div>
