	...
	<div class="col-12 mt-10">
		...
		<div class="alert mt-10 pim-body bg-white">
			<div class="row">
				...
				<div class="col-1">
					<a class="btn btn-bg-red-xs" data-bs-toggle="modal" data-bs-target="#delete-kgi" onclick="javascript:prepareDeleteKgi(<?= $kgiId ?>)">Delete
						...
						<div class="row">
							...
							<div class="col-lg-3 pim-subheader-font border-right-<?= $colorFormat ?> pl-18">
								...
								<div class="col-12 border-bottom-<?= $colorFormat ?> pb-5 pim-duedate">
									<i class="fa fa-diamond" aria-hidden="true"></i> <?= $kgiDetail["quantRatio"] == 1 ? 'Quantity' : 'Quality' ?>
								</div>
							...
							<div class="col-lg-7 pim-subheader-font pr-15 pl-15">
								<div class="row">
									...
									<div class="col-4 mt-5 pl-0 pr-0 ">
										...
										<div class="col-12 text-start pim-duedate"><?= $kgiDetail['nextCheckText'] == "" ? 'Not set' : $kgiDetail['nextCheckText'] ?></div>
									</div>
									...
									<div class="col-4 pl-0 pr-5 mt-5 ">
										...
										<div class="col-12 text-end pim-duedate"><?= $kgiDetail['nextCheckText'] == "" ? 'Not set' : $kgiDetail['nextCheckText'] ?></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								if (isset($kgiDetail["kgiEmployeeDetail"]) && count($kgiDetail["kgiEmployeeDetail"]) > 0) {
									foreach ($kgiDetail["kgiEmployeeDetail"] as $employeeId => $employee): ?>
										<div class="col-lg-4 col-md-6 col-12 mt-10 pt-0" onclick="javascription:openEmployeeView(134,31)" style="cursor: pointer;">
											<div class="row">
