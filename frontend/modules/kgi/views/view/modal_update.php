<div class="modal fade" id="update-kgi-modal-team" tabindex="-1" aria-labelledby="staticBackdropLabel2"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-12">
                    <div class="col-12">
                        <label for="exampleFormControlTextarea1" class="form-label font-size-13"> <?= Yii::t('app', 'KGI Description') ?></label>
                        <div class="col-12 border  pt-5 pl-10 pb-5 text-secondary font-size-12"
                            style="min-height: 50px;border-radius:5px;" id="kgi-detail"></div>
                    </div>
                    <div class="col-12 mt-10">
                        <label for="exampleFormControlTextarea1" class="form-label font-size-13"> <?= Yii::t('app', 'Team Remark') ?></label>
                        <div class="col-12 border  pt-5 pl-10 pb-5 text-secondary font-size-12"
                            style="min-height: 50px;border-radius:5px;" id="kgi-remark"></div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12 mt-10">
                            <label for="input" class="form-label font-size-13"><strong class="red">*</strong> <?= Yii::t('app', 'Check') ?>
                                <?= Yii::t('app', 'Unit') ?></label>
                        ...
                        <div class="col-6 mt-10">
                            ...
                            <input type="text" class="form-control font-size-13 text-end" id="target-amount"
                                name="targetAmount" <?php // $isManager == 0 ? 'disabled' : '' 
                                                    ?> required>
                        </div>
                        <div class="col-6 mt-10">
                            <label for="exampleFormControl" class="form-label font-size-13"><strong
