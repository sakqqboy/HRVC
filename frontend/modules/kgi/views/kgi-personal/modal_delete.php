<div class="modal fade" id="delete-kgi-employee" tabindex="-1" aria-labelledby="staticBackdrop4Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 8px; padding:20px;">
            ...
            <div class="d-flex justify-content-end" style="width:100%;border-top: none; padding-top: 20px;">
                ...
                <a href="javascript:deleteKgiEmployee()" class="d-flex btn btn-outline-danger" style="min-width: 100px;font-weight:500;"
