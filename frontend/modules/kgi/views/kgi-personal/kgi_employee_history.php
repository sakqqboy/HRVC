		...
		?>
			<div class="alert mt-10 pim-body bg-white">
				...
				<div class="row mt-10">
									...
									<div class="row">
										<div class="offset-1 col-8">
											...
											<div class="text-center priority-box">
												...
												<div class="col-12 text-priority"><?= $kgiEmployeeDetail["priority"] ?></div>
											</div>
										</div>
									</div>
					...
					<div class="col-lg-7">
						<div class="row">
							<div class="col-2  view-tab-active" id="tab-1" onclick="javascript:viewTabEmployeeKgi(<?= $kgiEmployeeHistoryId ?>,1,<?= $kgiId ?>,<?= $kgiEmployeeId ?>)">
							...
							<div class="col-3  view-tab" id="tab-2" onclick="javascript:viewTabEmployeeKgi(<?= $kgiEmployeeHistoryId ?>,2,<?= $kgiId ?>,<?= $kgiEmployeeId ?>)">
							...
							<div class="col-2  view-tab" id="tab-3" onclick="javascript:viewTabEmployeeKgi(<?= $kgiEmployeeHistoryId ?>,3,<?= $kgiId ?>,<?= $kgiEmployeeId ?>)">
							...
							<div class="col-2  view-tab" id="tab-4" onclick="javascript:viewTabEmployeeKgi(<?= $kgiEmployeeHistoryId ?>,4,<?= $kgiId ?>,<?= $kgiEmployeeId ?>)">
							...
							<div class="col-3  view-tab" id="tab-5" onclick="javascript:viewTabEmployeeKgi(<?= $kgiEmployeeHistoryId ?>,5,<?= $kgiId ?>,<?= $kgiEmployeeId ?>)">
...
<script>
	window.onload = function() {
		...
		if (openTab) {
			viewTabEmployeeKgi(<?= $kgiEmployeeHistoryId ?>, openTab, <?= $kgiId ?>, <?= $kgiEmployeeId ?>); // Set the tab based on the PHP value
		} else {
			viewTabEmployeeKgi(<?= $kgiEmployeeHistoryId ?>, 1, <?= $kgiId ?>, <?= $kgiEmployeeId ?>); // Default to tab 1 if no value is passed
		}
	}
</script>