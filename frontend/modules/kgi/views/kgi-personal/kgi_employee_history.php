...
$this->title = Yii::t('app', 'Individual KGI View');
?>
        ...
        <div class="col-12 mt-10">
            <div class="alert mt-20 pim-body bg-white" style="border: 1px solid #BBCDDE;">
                <div class="row" style="--bs-gutter-x:0px;">
                    <div class="col-6 pim-name-title" style="display: flex; align-items: center; gap: 14px;">
                        ...
                        <div class="d-flex justify-content-end align-items-end">
                            ...
                            ?>
                                <a class="btn btn-outline-danger d-flex justify-content-center align-items-center"
                                    data-bs-toggle="modal" data-bs-target="#delete-kgi-employee"
