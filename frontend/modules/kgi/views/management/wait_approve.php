...
<div class="col-12 mt-90">
	<div class="row">
		<div class="col-8">
			<i class="fa fa-clock-o font-size-20" aria-hidden="true"></i> <strong class="font-size-20"> Waiting for approve KGI</strong>
		</div>
				...
				<tbody>
					...
					?>
							<tr class="font-size-12">
								...
								<td class="text-center">
									<a href="<?= Yii::$app->homeUrl ?>kgi/management/approve-kgi-team/<?= ModelMaster::encodeParams(["kgiTeamHistoryId" => $kgiTeamHistoryId]) ?>" class="btn btn-sm btn-primary font-size-10">
										<i class="fa fa-eye" aria-hidden="true"></i>
									</a>
								</td>
							</tr>
