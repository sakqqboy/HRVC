<div class="header-pim">
	<ul class="nav nav-pills" id="pills-tab" role="tablist">
		...
		<li class="header-item">
			<a href="<?= Yii::$app->homeUrl ?>kgi/management/grid" class="nav-link text-dark active" id="pills-Group-tab" type="button" role="tab" aria-controls="pills-Group" aria-selected="false">
