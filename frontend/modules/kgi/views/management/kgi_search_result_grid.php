											...
											<div class="col-lg-3 col-md-6 col-12 progress-bordersolid">
												<div class="row">
													...
													<div class="col-md-5">
														...
														<div class="col-12 target-million mt-15">
															<?php
															if ($kgi["result"] != '') {
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="row">
															...
															if ($role >= 3) {
															?>
																<div class="col-3 pencil-nextupdate text-end" data-bs-toggle="modal" data-bs-target="#update-kgi-modal" onclick="javascript:updateKgi(<?= $kgiId ?>)">
