<ul>
					...
					<div class="col-12 pr-10 mr-10  pb-10" style="background-color:#F5F5F5;border-radius:5px;">
						<div class="row">
							<div class="col-lg-7 col-md-6 col-12 pt-15 pl-20">
								...
								<span class="text-dark font-size-14"> <?= $kgiName ?><span class="text-secondary font-size-12"> &nbsp;<?= number_format($fileSize, 2) ?> mb</span></span>
							</div>
					...
					<div class="col-12 card-dashed-gray">
						...
						<div class="col-12 mt-20">
							<div class="input-group pr-20">
								<div id="fileName-<?= $kgiIssueId ?>" class="col-12 text-end font-size-14"></div>
								<input for class="form-control" id="answer-<?= $kgiIssueId ?>">
								<label for="attachKgiFileAnswer-<?= $kgiIssueId ?>" class="mt-7" style="cursor: pointer;">
								...
								<a href="javascript:answerKgiIssue(<?= $kgiIssueId ?>)" class="btn btn-primary font-size-13 pt-8">
	...
	$form = ActiveForm::begin([
		'id' => 'create-new-kgi-issue',
		'method' => 'post',
		'options' => [
			'enctype' => 'multipart/form-data',
		],
		'action' => Yii::$app->homeUrl . 'kgi/management/create-new-issue'
	...
	<li class="li-circle1">
		<div class="col-12 card-hashed">
			...
			<div class="col-12 mt-20">
				<div class="input-group pr-20">
					<div id="attachFile-<?= $kgiId ?>" class="col-12 text-end font-size-14"></div>
					<input class="form-control" name="newIssue" required>
					<label for="attachKgiFile" style="margin-top: -10px;">
						<i class="fa fa-paperclip clip-file" aria-hidden="true"></i>
					</label>
