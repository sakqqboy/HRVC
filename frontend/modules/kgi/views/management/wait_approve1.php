                        ...
                        ?>
                                ...
                                <tr class="pim-bg-<?= $colorFormat ?> pim-table-text">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?= Yii::$app->homeUrl ?>kgi/kgi-team/kgi-team-history/<?= ModelMaster::encodeParams(['kgiTeamId' => $teamKgi['kgiTeamId'], 'kgiTeamHistoryId' => 0, 'openTab' => 1, "kgiId" => $teamKgi["kgiId"]]) ?>"
