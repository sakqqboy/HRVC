		...
		<div class="modal-content">
			<div class="modal-header" style="border: none;">
				...
				<div class="modal-title flag-Backdrop7" id="exampleModalViewkgi3Label">
					...
					<span class="ml-10" id="kgi-name-team"></span>
				</div>
				<div class="modal-title border Completed-Backdrop7 badge rounded-pill bg-warning text-dark" id="status-team"></div>
				<span class="border border-1 border-deadline-Backdrop7"><?= Yii::t('app', 'Deadline') ?> <span class="font-size-10 text-dark pr-10"> : <span id="period-date-team"></span></span></span>
			</div>
			<div class="col-12 text-end">
				<div class="row">
					<div class="col-6 text-start pl-30 font-b" id="team-name"></div>
					<div class="col-6 text-end">
						<span class="border border-1 border-next-Backdrop7"><?= Yii::t('app', 'Next Update') ?> <span class="font-size-10 text-dark pr-10"> : <span id="next-date-team"></span></span></span>
					</div>
				</div>
			...
			<div class="modal-body">
				...
				<hr>
				<div class="col-12 history-box" id="kgi-history-team">
