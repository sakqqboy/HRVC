<div class="modal fade" id="modal-kpi" tabindex="-1" aria-labelledby="staticBackdropLabel2" aria-hidden="true" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="col-12 font-b" style="margin-top: -35px; padding-left:20px; font-size: 16px;">
				<i class="fa fa-flag" aria-hidden="true"></i> <span id="kgi-name-p"></span>
			</div>
			<div class="modal-body pb-20 mb-20" id="related-kpi">
