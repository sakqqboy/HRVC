                ...
                <div class="row" style="--bs-gutter-x:0px;">
                    <div class="col-lg-4 col-12 pr-30">
                        ...
                        <div class="form-group mt-37" style="display: flex; flex-direction: column; align-items: flex-start; gap: 14px;">
                            ...
                            <div class="form-control d-flex justify-align-content-start" id="multi-branch" style="width: 100%">
                                <span id="multi-branch-text" class="align-content-center"><?= Yii::t('app', 'Select Branches') ?></span>
                                <div class="flex-grow-1 circle-container pl-15 justify-content-end" id="image-branches" data-type="branch" style="display: flex;
                                    align-items: center;
                                    gap: 5px;">
                                    ...
                                    <div class="cycle-current-gray" style="color: #000;"
                        ...
                        <div class="form-group mt-37" style="display: flex; flex-direction: column; align-items: flex-start; gap: 14px;">
                            ...
                            <div class="form-control d-flex justify-align-content-start" id="multi-department" style="width: 100%">
                                <span id="multi-department-text" class="align-content-center" style="flex-grow: 1;color: #8a8a8a;">
                                ...
                                <div class="flex-grow-1 circle-container pl-15 justify-content-end" id="image-branches" data-type="branch" style="display: flex;
                                    ...
                                    <i class="toggle-icon-department fa fa-angle-down pull-right" aria-hidden="true"></i>
                                </div>
                            </div>
                        ...
                        <div class="form-group mt-27" style="display: flex; flex-direction: column; align-items: flex-start; gap: 14px;">
                            ...
                            <div class="form-control d-flex justify-align-content-start" id="multi-team" style="width: 100%;">
                    ...
                    <div class="col-lg-4 col-12 pl-20">
                        ...
                        <div class="form-group mt-42"
                            ...
                            <label class="text-manage-create" for="name"
                                ...
                                <div style="flex-grow: 1;">
                                    <span class="text-danger">* </span>
                                    <?= Yii::t('app', 'Details') ?>
                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/help.svg" data-toggle="tooltip" class="tootip-icon"
                        ...
                        <div class="form-group <?= $statusform == 'update' ? 'mt-40' : 'mt-60' ?>" style="display: flex; align-items: flex-end; justify-content: flex-end; gap: 7px; width: 100%;">
                            <?php
                            // $status = 'create';
                            // $statusform = 'update';
