                            ...
                            <div class="d-flex justify-content-start align-content-start">
                                    ...
                                    <div class="mt-20">
                                        ...
                                        <div class="d-flex justify-content-start">
                                            <div class="mt-15" style="gap: 10px;display:inline-grid;">
                                                <div class="d-flex  justify-content-start" style="gap: 8px;">
                                                    <div class="pim-picgroup">
                                                        ...
                                                        <div class="number-tagNew  <?= $kgi["countEmployee"] == 0 && $colorFormat != "disable"  ? 'load-yenlow' : 'load-'  . $colorFormat ?>  pic-after">
                                                            <?= $kgi["countEmployee"] ?>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex justify-content-start">
                                                ...
                                                <div class="d-flex  justify-content-start" style="gap: 8px;">
                                                    <div class="pim-picgroup">
                                                        ...
                                                        for ($i = 1; $i <= 3; $i++):
                                                        ?>
                                                            <div class="pim-pic-<?= $colorFormat ?>  <?= $i > 1 ? 'pic-after' : '' ?>">
                                            ...
                                            <div class="flex-grow-1  d-flex justify-content-end">
                                                <div style="width:45px;justify-items: center;align-content: start;display: inline-grid;gap:2px;">
                                ...
                                <div class="d-flex flex-column kgi-grid-2">
                                    ...
                                    <div class="d-grid  pl-10 pr-10" style="gap: 7px;">
                                        ...
                                        <div class="pim-unit-text">
                                            <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/monthly.svg" style="width:10px;height:10px;">
                                            <?= Yii::t('app', $kgi["unit"]) ?>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-4 text-center align-content-center">
                                                    ...
                                                    ?>
                                                        <a href="<?= Yii::$app->homeUrl . 'kgi/management/prepare-update/' . ModelMaster::encodeParams(['kgiId' => $kgiId, 'kgiHistoryId' => 0]) ?>"
                                                            ...
                                                            <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/refresh.svg" class="mr-3"
                                                                style="width: 10.42px; height: 10.53px;">
                                                            <?php
                                                            if ($colorFormat == "over") {
                                                                echo Yii::t('app', 'Update');
                                                    ...
                                                    <?php  } else { ?>
                                                        <div class="col-5 <?= $kgi["countEmployee"] == 0 ? ($colorFormat == 'disable' ? 'disable' : 'yenlow') : $colorFormat ?>-assignNew ">
                                                            ...
                                                            <a href="<?= Yii::$app->homeUrl ?>kgi/assign/assign/<?= ModelMaster::encodeParams([
                                                                ...
                                                                class="font-<?= $kgi["countEmployee"] == 0 ? ($colorFormat == 'disable' ? 'disable' : 'black') : $colorFormat ?>" style="top: 2px;">
                                                                <?php if ($kgi["countEmployee"] == 0 && $colorFormat == 'disable') { ?>
                                                    ...
                                                    <?php  } else { ?>
                                                        <div
                                                            ...
                                                            <a href="<?= Yii::$app->homeUrl ?>kgi/assign/assign/<?= ModelMaster::encodeParams([
                                                                ...
                                                                class="font-<?= ($kgi["countTeam"] == 0 && $colorFormat == 'disable') ? 'black' : $colorFormat ?>"
                                                                <?= ($kgi["countTeam"] == 0 && $colorFormat == 'disable') ?: '' ?> style="top: 2px;">
                                                                <?php if ($kgi["countTeam"] == 0 && $colorFormat == 'disable') { ?>
