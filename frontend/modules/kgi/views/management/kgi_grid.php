                                            ...
                                            <div class="col-10 pl-20 pr-0 mt-10">
                                                <div class="col-12 pb-1">
                                                    <div class="row">
                                                        ...
                                                        <?php if ($role <= 4) { ?>
                                                            <div class="col-7 <?= $kgi["countEmployee"] == 0 ? ($colorFormat == 'disable' ? 'disable' : 'yenlow') : $colorFormat ?>-assignNew ">
                                                ...
                                                <div class="col-12 mt-10 pt-5 pb-1">
                                                    <div class="row">
                                                        ...
                                                        <?php  } else { ?>
                                                            <div class="col-7 <?= $kgi["countTeam"] == 0 ? ($colorFormat == 'disable' ? 'disable' : 'yenlow') : $colorFormat ?>-assignNew ">
                                                                <span class="pull-left">
