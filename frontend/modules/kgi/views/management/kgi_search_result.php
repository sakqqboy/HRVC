			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-12  pr-0">
					<div class="row">
						...
						<div class="col-5 text-end">
							...
							if ($role >= 3) {
							?>
								<button type="button" class="btn-create font-size-10" data-bs-toggle="modal" data-bs-target="#staticBackdrop5">
				...
				<div class="col-lg-1 col-md-6 col-12 pr-0 text-end">
					<div class="btn-group" role="group">
						<a href="<?= Yii::$app->homeUrl . 'kgi/management/grid' ?>" class="btn btn-outline-primary font-size-12 pim-change-mode">
