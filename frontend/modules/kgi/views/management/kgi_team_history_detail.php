...
<div class="contrainer-body">
    <div class="row">
        <div class="col-8">
            ...
            <span class="pim-head-text"> <?= Yii::t('app', 'Request changing KGI Team target') ?></span>
        </div>
    ...
    <div class="row mt-20 pl-15 pr-15">
        <div class="col-lg-6 col-md-6 col-12 pim-body bg-white"
            ...
            <table class="table table-condensed mt-10">
                ...
                <tbody>
                    ...
                    <tr class="font-size-12">
                        <td><?= $a ?></td>
                        <td class="text-end font-b">
                            <?= $decimalTarget[1] == '00' ? number_format($history["target"]) : number_format($history["target"], 2) ?>
                        </td>
        ...
        <div class="col-lg-6 col-md-6 col-12 pim-body bg-white"
            ...
            <div class="col-12 font-b pb-5 border-bottom text-end"><?= Yii::t('app', 'Assigned Teams') ?></div>
            <?php
            ...
            <table class="table table-condensed mt-10">
                ...
                <tbody>
                    ...
                    <tr class="font-size-12">
                        ...
                        <td class="text-end border-right <?= $teamName == $team["teamName"] ? 'font-b' : '' ?>">
                            <?= $decimalTarget[1] == '00' ? number_format($team["target"]) : number_format($team["target"], 2) ?>
                        </td>
                        <td class="text-end border-right">
                            <?= $decimalResult[1] == '00' ? number_format($team["result"]) : number_format($team["result"], 2) ?>
                        </td>
