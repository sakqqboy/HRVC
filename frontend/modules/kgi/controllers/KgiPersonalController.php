...
class KgiPersonalController extends Controller
{
	...
	public function actionIndividualKgi($hash = null)
	{
	...
	public function actionIndividualKgiGrid($hash = null)
	{
		...
		return $this->render('individual_kgi_grid', [
			...
			"status" => null,
			"year" => null,
			"waitForApprove" => isset($waitForApprove["totalRequest"]) ? $waitForApprove["totalRequest"] : $waitForApprove["totalRequest"] = 0,
			"employeeCompanyId" => $employeeCompanyId,
			"totalKgi" => $totalKgi,
			"currentPage" => $currentPage,
			"totalPage" => $totalPage,
