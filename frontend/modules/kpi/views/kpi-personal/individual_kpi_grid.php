			...
			<div class="alert mt-10 pim-body bg-white">
				<div class="row">
					...
					<div class="col-lg-1 col-md-6 col-12 pr-0 text-end">
						<div class="btn-group" role="group">
							<a href="<?= Yii::$app->homeUrl ?>kpi/kpi-personal/individual-kpi-grid" class="btn btn-primary font-size-12 pim-change-mode">
								<i class="fa fa-th-large" aria-hidden="true"></i>
							</a>
							<a href="<?= Yii::$app->homeUrl ?>kpi/kpi-personal/individual-kpi" class="btn btn-outline-primary font-size-12 pim-change-mode">
				...
				<div class="col-12 mt-5">
					<div class="row">
						...
						?>
								<div class="col-12 mt-10 mb-5 pim-big-box pim-<?= $colorFormat ?>" id="kpi-employee-<?= $kpiEmployeeId ?>">
									<div class="row">
										...
										<div class="col-lg-5 col-md-2 col-4 text-end pr-20 ">
											...
											<a class="btn btn-bg-white-xs mr-5" href="<?= Yii::$app->homeUrl ?>kpi/view/kpi-individual-history/<?= ModelMaster::encodeParams(['kpiId' => $kpi['kpiId'], "kpiEmployeeId" => $kpiEmployeeId]) ?>" style="margin-top: -3px;">
											...
											<a class="btn btn-bg-white-xs mr-5" data-bs-toggle="modal" data-bs-target="#staticBackdrop3" onclick="javascript:kpiHistory(<?= $kpiEmployeeId ?>)" style="margin-top: -3px;">
												<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/chart.png" alt="History" class="pim-icon mr-3" style="margin-top: -2px;">Chart
											</a>
											<?php
											if ($role >= 5) {
											?>
												<a class="btn btn-bg-red-xs" data-bs-toggle="modal" data-bs-target="#delete-kpi-employee" onclick="javascript:prepareDeleteKpiEmployee(<?= $kpiEmployeeId ?>)" style="margin-top: -3px;">
															...
															<div class="col-5 border-right pr-2 pl-13">
																<div class="row">
																	<div class="col-2">
																		...
																		?>
																			<img src="<?= Yii::$app->homeUrl . $kpi['teamMate'][0] ?>" class="pim-pic-grid">
																		<?php
																		}
																		?>
																	</div>
																	<div class="col-2 pic-after pt-0">
																		...
																		?>
																			<img src="<?= Yii::$app->homeUrl . $kpi['teamMate'][1] ?>" class="pim-pic-grid">
																		<?php
																		}
																		?>
																	</div>
																	<div class="col-2 pic-after pt-0">
																		...
																		?>
																			<img src="<?= Yii::$app->homeUrl . $kpi['teamMate'][2] ?>" class="pim-pic-grid">
																		<?php
																		}
																		?>
																	</div>
