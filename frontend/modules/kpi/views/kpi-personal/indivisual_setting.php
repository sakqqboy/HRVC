...
$this->title =  Yii::t('app', 'KPI Individual Setting');
?>
	...
	<div class="row">
		<div class="col-8">
			...
			<strong class="font-size-20">
				<?= Yii::t('app', 'Indivisual KPI Setting') ?>
			</strong>
		</div>
	...
	<div class="col-12 mt-20">
		...
		?>
				<div class="row mt-20">
					...
					<div class="col-5 text-end font-size-16 font-b mt-10 mb-10 border-bottom pb-10">
						<?= Yii::t('app', 'Target') ?> : : <?= number_format(KpiTeam::teamTarget($teamId, $kpiId), 2) ?>
					</div>
				</div>
				<?php
		...
		<?php
			...
			<div class="col-12 text-center font-size-14 mt-20">
				<?= Yii::t('app', "This Kpi haven't assiged to any employee") ?>.
			</div>
		<?php
		}
		ActiveForm::end(); ?>
