        ...
        <div class="modal-content" style="display: flex; gap: 21px;padding:20px 25px;">
            ...
            <div class="contrainer-body-detail" id="show-modal-history"
                ...
                <div class="" style="display: flex; justify-content: space-between; align-items: center; gap: 15px; width: 100%;">
                    <div class="alert  bg-white" style="width: 623px; height: 562px; padding: 20px 20x;">
                        <div style="display: flex;flex-direction: column;align-items: flex-start;gap: 10px;">
                            ...
                            <div class="tab-pane fade show active fade" style="gap: 14px; width: 100%; max-height: 450px; overflow-y: auto;">
                ...
                <div style="display: flex; justify-content: flex-end; align-items: center; gap: 10px;">
                    ...
                    <button type="button" class="btn-order-history" data-bs-dismiss="modal"><?= Yii::t('app', 'Close') ?></button>
                </div>
            </div>
