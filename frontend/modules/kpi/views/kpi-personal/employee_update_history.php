...
$form = ActiveForm::begin([
    ...
    'action' => Yii::$app->homeUrl . 'kpi/kpi-personal/save-update-employee-history'
]);
            ...
            <div class="row" style="--bs-gutter-x:0px;">
                <div class="col-6 align-content-center" style="height:55px;">
                    <div class="pim-name-title" style="display: flex; align-items: center; gap: 14px;">
                        <a href="<?= Yii::$app->request->referrer ? Yii::$app->request->referrer : Yii::$app->homeUrl . 'kpi/kpi-personal/individual-kpi-grid' ?>" style="text-decoration: none; width:70px; height:26px;" class="btn-create-branch">
                ...
                <div class="row" style="--bs-gutter-x:0px;">
                    ...
                    <div class="col-lg-4 col-12 pl-30">
                        ...
                        <div class="form-group mt-55 d-flex justify-content-end gap-2">
                            <a href="<?= Yii::$app->homeUrl ?>kpi/kpi-personal/individual-kpi-grid" class="btn-create-cancle" style="width: 80px; text-decoration: none; height: 35px;"><?= Yii::t('app', 'Cancel') ?></a>
...
<script>
    $(document).ready(function() {
        ...
        $("#update-personal-kpi").on("beforeSubmit", function() {
    ...
    function kpiUpdateHistory(kpiId) {
        ...
        console.log("Viewing history for KPI ID: " + kpiId);
