...
<div class="row">
    <!-- <div class="col-1 pr-10 text-end">
		<span>
			<img src="<?= Yii::$app->homeUrl ?>images/icons/Dark/48px/FilterPlus.png" class="pim-search-icon" style="cursor: pointer;" onclick="javascript:kpiFilterForEmployee()">
		</span>
	</div> -->
    <?php
	if ($role > 3) {
    ...
    <div class="col-1 pl-0">
        <span class="btn font-size-12 justify-content-center d-flex align-items-center custom-button-select"
            ...
            <img src="<?= Yii::$app->homeUrl ?>images/icons/Dark/48px/FilterWhite.svg" class="pim-search-icons me-2
                style=" cursor: pointer;" onclick="javascript:kpiFilterForEmployee()">
            Filter
        </span>
    </div>
</div>
