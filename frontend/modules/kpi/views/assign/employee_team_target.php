<div class="col-12 bg-header-assign pb-0 pt-0 pr-8 mt-10" id="team-employee-<?= $teamId ?>">
	<div class="row">
		<div class="col-5 font-size-12 pt-5 pb-3">
			...
			<b><?= $teamDetail["teamName"] ?>, </b><span class="col-12 font-size-10"><?= $teamDetail["departmentName"] ?></span>
		</div>
			...
			<div class="col-12 bg-white border-bottom">
				<div class="row">
					...
					<div class="col-3 font-size-12 text-center pt-5">
						<input type="text" name="employeeTarget[<?= $employeeId ?>]" class="assign-target text-end" placeholder="Target" style="height: 30px;" value="<?= number_format($employee['target'], 2) ?>" id="employee-target-<?= $teamId ?>" onkeyup="javascript:calculateEmployeeTargetValue(<?= $teamId ?>)">
					</div>
