...
$this->title = Yii::t('app', 'Self KPI History');
?>
    ...
    <div class="col-12 mt-20" id="box-wrapper">
        <div class="bg-white-employee">
            <div class="pim-name-title" style="display: flex; align-items: center; gap: 14px;">
                ...
                <a href="<?= isset(Yii::$app->request->referrer) ? Yii::$app->request->referrer : Yii::$app->homeUrl . 'kpi/kpi-personal/individual-kpi-grid' ?>" style="text-decoration: none; width:66px; height:26px;" class="btn-create-branch">
                                            ...
                                            <div class="d-flex justify-content-end" style="height:32px;">
                                                ...
                                                <a href="<?= Yii::$app->homeUrl ?>kpi/kpi-personal/kpi-individual-history/<?= ModelMaster::encodeParams(['kpiId' => $kpiId, 'kpiEmployeeHistoryId' => $kpi["kpiEmployeeHistoryId"], 'kpiEmployeeId' => $kpiEmployeeId, 'openTab' => 3]) ?>"
                                                    ...
                                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/comment.svg"
                                                        alt="Comment" class="pim-action-icon">
                                                </a>
                                                ...
                                                ?>
                                                    <a href="<?= Yii::$app->homeUrl ?>kpi/kpi-personal/employee-update-history/<?= ModelMaster::encodeParams(['kpiId' => $kpiId, 'kpiEmployeeHistoryId' => $kpi["kpiEmployeeHistoryId"], 'kpiEmployeeId' => $kpiEmployeeId]) ?>"
