		...
		<div class="col-12 mt-15 pt-0" style="height:295px;overflow-y: auto;">
			<div class="row">
				<div class="col-12">
					...
					?>
								<div class="col-12 font-blue font-size-12 <?= $i > 0 ? 'mt-10' : '' ?>"><?= ModelMaster::monthEng($month, 1) . ' ' . $year  ?></div>
								<?php
								if (count($detail) > 0) {
									$j = 0;
											...
											<div class="row">
												<div class="col-4">
													<div class="col-12 font-size-12 pl-0 pt-3 font-b">
														<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/check-black.png" class="pim-icon mr-3" style="margin-top: -3px;">
														<?php
														if ($info["status"] == 1) {
...
<div class="col-lg-6">
	<div class="col-12 ligth-gray-box">
		...
		<div class="col-12 alert  mt-15 pt-0" style="height:280px;overflow-y: auto;">
			<div class="col-12 font-size-12">
				<div class="row">
					<div class="col-8"></div>
					<div class="col-4 text-center font-b">Target / <span class="font-blue">Result</span></div>
				</div>
