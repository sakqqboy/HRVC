	...
	<div class="col-12 mt-10">
		...
		<div class="alert mt-10 pim-body bg-white">
			<div class="row">
				...
				<div class="col-1">
					<a class="btn btn-bg-red-xs" data-bs-toggle="modal" data-bs-target="#delete-kpi" onclick="javascript:prepareDeleteKpi(<?= $kpiId ?>)">Delete
			...
			<div class="row mt-10">
						...
						<div class="row">
							...
							<div class="col-lg-3 pim-subheader-font border-right-<?= $colorFormat ?> pl-18">
								...
								<div class="col-12 border-bottom-<?= $colorFormat ?> pb-5 pim-duedate">
									<i class="fa fa-diamond" aria-hidden="true"></i> <?= $kpiDetail["quantRatio"] == 1 ? 'Quantity' : 'Quality' ?>
								</div>
							...
							<div class="col-lg-7 pim-subheader-font pr-15 pl-15">
								<div class="row">
									...
									<div class="col-4 mt-5 pl-0 pr-0 ">
										...
										<div class="col-12 text-start pim-duedate"><?= $kpiDetail['nextCheckText'] == "" ? 'Not set' : $kpiDetail['nextCheckText'] ?></div>
									</div>
									<div class="col-4 text-center mt-5 pt-6 pl-3 pr-3">
										<?php
										if ($role > 3  && $kpiDetail["status"] == 1) {
										?>
											<div onclick="javascript:updateKpi(<?= $kpiId ?>)" class="pim-btn-<?= $colorFormat ?>" data-bs-toggle="modal" data-bs-target="#update-kpi-modal">
									...
									<div class="col-4 pl-0 pr-5 mt-5 ">
										<div class="col-12 text-end font-<?= $colorFormat ?>" style="letter-spacing:0.3px;font-size:9px;">
											Next Update Date
										</div>
										<div class="col-12 text-end pim-duedate"><?= $kpiDetail['nextCheckText'] == "" ? 'Not set' : $kpiDetail['nextCheckText'] ?></div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-7">
					<div class="row">
						<div class="col-2  view-tab-active" id="tab-1" onclick="javascript:viewTabKpi(1)">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/team-blue.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;" id="tab-1-blue">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/team-black.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;display:none;" id="tab-1-black">
							Assigned
						</div>
						<div class="col-3  view-tab" id="tab-2" onclick="javascript:viewTabKpi(2)">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/refresh.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;" id="tab-2-black">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/refresh-blue.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;display:none;" id="tab-2-blue">
							Update History
						</div>
						<div class="col-2  view-tab" id="tab-3" onclick="javascript:viewTabKpi(3)">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/comment.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;" id="tab-3-black">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/comment-blue.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;display:none;" id="tab-3-blue">
							Chats
						</div>
						<div class="col-2  view-tab" id="tab-4" onclick="javascript:viewTabKpi(4)">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/chart.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;" id="tab-4-black">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/chart-blue.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;display:none;" id="tab-4-blue">
							Chart
						</div>
						<div class="col-3  view-tab" id="tab-5" onclick="javascript:viewTabKpi(5)">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/relate.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;" id="tab-5-black">
							<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/relate-blue.png" alt="History" class="pim-icon mr-5" style="margin-top: -2px;display:none;" id="tab-5-blue">
							Relate KGI
						</div>
											...
											<div class="col-12 small-content bg-white pl-20">
												<div class="row">
													<div class="col-2  pl-0 pr-0">
														<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/team.png" class="image-AssignMembers">
													</div>
							...
							<div class="row">
								...
								if (isset($kpiDetail["kpiEmployeeDetail"]) && count($kpiDetail["kpiEmployeeDetail"]) > 0) {
									foreach ($kpiDetail["kpiEmployeeDetail"] as $employeeId => $employee): ?>
										<div class="col-lg-4 col-md-6 col-12 mt-10 pt-0" onclick="javascription:openKpiEmployeeView(<?= $employeeId ?>,<?= $kpiId ?>)" style="cursor: pointer;">
											<div class="row">
