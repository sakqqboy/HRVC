                                        ...
                                        <div>
                                            <div class="assign-new <?= $colorFormat ?>-assignNew">
                                                <div class="pim-picgroup">
                                                    <?php if ($kpi["employee"] != 0) {
                                                        $totalPic = $kpi["employee"] >= 3 ? 3 : $kpi["employee"];
                                                ...
                                                if ($role > 3) {
                                                ?>
                                                    <a href="<?= Yii::$app->homeUrl ?>kpi/assign/assign/<?= ModelMaster::encodeParams(['kpiId' => $kpiId, "companyId" => $kpi["companyId"], "save" => 0, 'kpiHistoryId' => $kpi['kpiHistoryId']]) ?>"
                                                        class="font-<?= $colorFormat ?>"
                                                        style="text-decoration: none; font-size: 12px; font-weight: 600;">
                                                        <?= $kpi["employee"] > 0 ? Yii::t('app', 'Assigned Person') : Yii::t('app', 'Assign Person') ?>
                                                    </a>
                                                <?php
                                                } else {
                                                ?>
                                                    <a href="<?= Yii::$app->homeUrl ?>kpi/view/kpi-history/<?= ModelMaster::encodeParams(['kpiId' => $kpiId, 'openTab' => 1, 'kpiHistoryId' => $kpi['kpiHistoryId']]) ?>"
                                                        class="font-<?= $colorFormat ?>"
                                                        style="text-decoration: none; font-size: 12px; font-weight: 600;">
                                                        <?= $kpi["employee"] > 0 ? Yii::t('app', 'View Person') : Yii::t('app', 'Not Yet') ?>
                                                    </a>
                                                <?php
                                                }
                                                ?>
