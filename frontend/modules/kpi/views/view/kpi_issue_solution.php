            ...
            <div class="row">
                <div class="col-12 head-gray-box pt-0">
                    ...
                    <div class="col-12">
                        ...
                        <textarea style="height: 150px;" class="form-control font-size-12" id="description"
                    ...
                    <div class="col-12 text-end mt-5 mb-10 ">
                        <label for="attachKpiFile">
                            <a class="btn btn-bg-white-xs pb-0 pt-3"
                                style="font-size: 10px;font-weight:300;margin:auto;">
                                <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/clip.png" class="attach-icon"
            ...
            <div class="col-12 mt-10" id="updated-issue">
                ...
                <div class="row pl-12">
                    ...
                    <div class="col-5 text-end pt-10 pim-create-time">
                        <i class="fa fa-circle mr-3 text-secondary "
                            aria-hidden="true"></i><?= $issue['createDateTime'] ?>
                    </div>
                </div>
                    ...
                    <div class="col-12 font-size-12 pt-5 pb-25">
                        <div class="row">
                            <div class="col-10 pr-0">
                                ...
                                <div class="col-12 mt-5" style=" text-indent: 30px; "> <?= $issue['description'] ?>
                                </div>
                            </div>
                            <div class="col-2 pl-0 pr-0 middle">
                                ...
                                <a href="<?= Yii::$app->homeUrl . $issue['file'] ?>" target="_blank"
                                    class="btn btn-bg-white-xs pb-0 pt-3"
                                    style="font-size: 10px;font-weight:300;margin:auto;">
                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/clip.png"
                                        class="attach-icon" style="margin-top:-5px;">
                                    <?= Yii::t('app', 'Attachment') ?>
                                </a>
                                <?php
										}
                ...
                <div class="col-12 mt-10" id="solution-<?= $kpiIssueId ?>">
                    ...
                    <div class="col-12 <?= $i < count($issue["solutionList"]) ? 'border-left-bottom-radius' : '' ?>"
                        style="<?= $i == 1 ? 'margin-top: -22px;' : 'margin-top: -10px;' ?>"
                        id="kpi-solution-<?= $kpiSolutionId ?>">
                        <div class="row">
                            ...
                            <div class="pim-create-time text-end pt-10" style="width: 40%;background-color:white;">
                                <i class="fa fa-circle mr-3 text-secondary "
                                    aria-hidden="true"></i><?= $data['createDateTime'] ?>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2  pl-0 pr-0 middle">
                                        <?php
														...
														?>
                                        <a href="<?= Yii::$app->homeUrl . $data['file'] ?>" target="_blank"
                                            class="btn btn-bg-white-xs pb-0 pt-3"
                                            style="font-size: 10px;font-weight:300;margin:auto;">
                                            <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/clip.png"
                                                class="attach-icon" style="margin-top:-5px;">
                ...
                <div class="col-12 mb-10" style="display:none;" id="answer-site-<?= $kpiIssueId ?>">
                    ...
                    <textarea name="" class="form-control font-size-12" id="answer-<?= $kpiIssueId ?>"
                    ...
                    <div class="col-12 text-end">
                        ...
                        <input id="attachKpiFileAnswer-<?= $kpiIssueId ?>" accept=".pdf" type="file"
                            style="display: none;" name="attachKpiFileAnswer-<?= $kpiIssueId ?>"
                            onchange="javascript:showSelectFileNameKpi(<?= $kpiIssueId ?>)">
                        <a href="javascript:answerKpiIssue(<?= $kpiIssueId ?>)"
                            class="btn-reply font-size-10 mt-5 mb-10 no-underline" style="height: 25px;">
                            <?= Yii::t('app', 'Reply Issue') ?>
                        </a>
                    </div>
                </div>
                <div class="col-12 text-end font-size-10 border-bottom pb-5 mb-15">
                    <a href="javascript:showAnswer(<?= $kpiIssueId ?>,1)"
                        id="reply-<?= $kpiIssueId ?>"><?= Yii::t('app', 'Reply') ?></a>
                    <a href="javascript:showAnswer(<?= $kpiIssueId ?>,2)" style="display:none;"
                        id="cancel-<?= $kpiIssueId ?>"><?= Yii::t('app', 'Cancel') ?></a>
                </div>
                <?php
						$i++;
					endforeach;
