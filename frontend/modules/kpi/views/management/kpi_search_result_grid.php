                                            ...
                                            <div class="row">
                                                <div class="col-4 pr-2 pl-13">
                                                    <div class="row d-flex align-items-center"
                                                        ...
                                                        <?php if (isset($kpi["countEmployee"]) && $kpi["countEmployee"] != 0) {
                                                                ?>
                                                        <div class="col-2">
                                                        ...
                                                        <div
                                                            class="col-5 number-tagNew  <?= isset($kpi["countEmployee"]) && $kpi["countEmployee"] == 0 && $colorFormat != "disable"  ? 'load-yenlow' : 'load-'  . $colorFormat ?> ">
                                                            <?= isset($kpi["countEmployee"]) ?>
                                                        </div>
                                                        <?php } else { ?>
                                                        <div class="col-2 ">
                                                            <div
                                                                class="<?= isset($kpi["countEmployee"]) && $kpi['countEmployee'] == 0 && $colorFormat != 'disable' ? 'pim-pic-yenlow' : 'pim-pic-' . $colorFormat ?>">
                                                                <img
