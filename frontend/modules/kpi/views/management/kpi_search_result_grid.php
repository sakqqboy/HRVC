			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-12 pr-0">
					<div class="row">
						<div class="col-12">
							<div class="row">
								<div class="col-3 pim-type-tab-selected pr-0 pl-0">
									Company KPI
								</div>
								...
								<div class="col-3 pim-type-tab">
									<a href="<?= Yii::$app->homeUrl ?>kpi/kpi-personal/individual-kpi-grid" class="no-underline-black">
										Self KPI
									</a>
								</div>
								<div class="col-3 pr-0 pl-5 pt-0">
									<?php
									if ($role >= 3) {
									?>
										<button type="button" class="btn-create font-size-10 text-center" data-bs-toggle="modal" data-bs-target="#creat-kpi" style="margin-top: 1px;position:absolute;">
											Create New KPI <i class="fa fa-magic ml-2" aria-hidden="true"></i>
										</button>
									<?php
									}
									?>
				...
				<div class="col-lg-1 col-md-6 col-12 pr-0 text-end">
					<div class="btn-group" role="group">
						...
						<a href="<?= Yii::$app->homeUrl . 'kpi/management/index' ?>" class="btn btn-outline-primary font-size-12 pim-change-mode">
							...
							<div class="col-12 mt-10 mb-5 pim-big-box pim-<?= $colorFormat ?>" id="kpi-<?= $kpiId ?>">
								<div class="row">
									...
									<div class="col-lg-5 col-md-2 col-4 text-end pr-20">
										<a href="<?= Yii::$app->homeUrl ?>kpi/view/index/<?= ModelMaster::encodeParams(['kpiId' => $kpiId]) ?>" class="btn btn-bg-white-xs mr-5" style="margin-top: -3px;">
											<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/eye.png" alt="History" class="pim-icon" style="margin-top: -1px;">
										</a>
										<a href="<?= Yii::$app->homeUrl ?>kpi/view/kpi-history/<?= ModelMaster::encodeParams(['kpiId' => $kpiId]) ?>" class="btn btn-bg-white-xs mr-5" style="margin-top: -3px;">
											<img src="<?= Yii::$app->homeUrl ?>images/icons/Dark/48px/Comment.png" alt="History" class="home-icon">
										</a>
										<a href="<?= Yii::$app->homeUrl ?>kpi/chart/company-chart/<?= ModelMaster::encodeParams(['kpiId' => $kpiId]) ?>" class="btn btn-bg-white-xs mr-5" style="margin-top: -3px;">
											<img src="<?= Yii::$app->homeUrl ?>images/icons/Dark/48px/Charts.png" alt="History" class="home-icon mr-3" style="margin-top: -3px;">Chart
										</a>
										<?php
										if ($role >= 5) {
										?>
											<a class="btn btn-xs btn-outline-danger" data-bs-toggle="modal" data-bs-target="#delete-kpi" onclick="javascript:prepareDeleteKpi(<?= $kpiId ?>)" style="margin-top: -3px;">
												...
												<div class="col-12 <?= $colorFormat ?>-assign  mt-5 pt-2 pb-1">
													<div class="row">
														...
														<div class="col-7 pl-3 pt-4 pr-15">
															...
															if ($role > 3) {
															?>
																<a href="<?= Yii::$app->homeUrl ?>kpi/assign/assign/<?= ModelMaster::encodeParams(['kpiId' => $kpiId, "companyId" => $kpi["companyId"]]) ?>" class="font-<?= $colorFormat ?>">
																	Assign Person
																</a>
															<?php
															} else {
															...
															<span class="pull-right">
																<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/assign-<?= $colorFormat ?>.png" class="home-icon" style="margin-top: -4px;">
															</span>
														</div>
													</div>
												</div>
												<div class="col-12 <?= $colorFormat ?>-assign  mt-10 pt-5 pb-1">
													<div class="row">
														<div class="col-5 border-right-<?= $colorFormat ?> pr-2">
															<div class="row">
																<div class="col-4">
																	<img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/team-<?= $colorFormat ?>.png" class="first-layer-icon ml-3" style="margin-top: -4px;">
																</div>
																<div class="col-4 number-tag load-<?= $colorFormat ?> pr-3 pl-3 pt-1 ml-5" style="height:18px;">
																	<?= $kpi["countTeam"] ?>
																</div>
															</div>
														</div>
														<div class="col-7 pl-3 pr-15">
															...
															?>
															<span class="pull-right" style="display:<?= $kpi['isOver'] == 2 ? 'none;' : '' ?>">
									...
									<div class="col-lg-3 pim-subheader-font border-right-<?= $colorFormat ?> pr-15 pl-15 mt-5">
										<div class="row">
											...
											<div class="col-4 pl-5 pr-5 mt-10">
												...
												<div class="col-12 text-start pim-duedate"><?= $kpi['nextCheck'] == "" ? 'Not set' : $kpi['nextCheck'] ?></div>
											</div>
											...
											<div class="col-4 pl-0 pr-5 mt-10">
												...
												<div class="col-12 text-end pim-duedate"><?= $kpi['nextCheck'] == "" ? 'Not set' : $kpi['nextCheck'] ?></div>
											</div>
										</div>
									</div>
