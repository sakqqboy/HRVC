<div class="modal fade" id="kpi-employee-modal" tabindex="-1" aria-labelledby="examdipleModalemployeeSearch" aria-hidden="true">
				...
				<div id="kpi-employee-modal">
					<div class="row">
						...
						<div class="col-lg-4 col-12 mt-20">
							<div class="col-12">
								<select class="form-select " onchange="javascript:searchKpiEmployee()" id="search-employee-department">
								</select>
							</div>
						</div>
						<div class="col-lg-4 col-12 mt-20">
							<div class="col-12">
								<select class="form-select " onchange="javascript:searchKpiTeam()" id="search-employee-team">
						...
						<div class="col-lg-4 col-12 mt-20">
							<div class="col-12">
								...
								<input class="form-control rounded pl-35" id="search-employee-kpi" type="search" placeholder="Search" aria-label="Search" onkeyup="javascript:searchKpiEmployee()">
							</div>
