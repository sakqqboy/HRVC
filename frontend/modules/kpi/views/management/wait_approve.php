				...
				<tbody>
					...
					?>
							<tr class="font-size-12">
								...
								<td class="text-center">
									<a href="<?= Yii::$app->homeUrl ?>kpi/management/approve-kpi-team/<?= ModelMaster::encodeParams(["kpiTeamHistoryId" => $kpiTeamHistoryId]) ?>" class="btn btn-sm btn-primary font-size-10">
										<i class="fa fa-eye" aria-hidden="true"></i>
									</a>
								</td>
							</tr>
