            ...
            <table class="">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            <td colspan="6" class="col-12 mt-20 font-size-14 text-secondary"> <?= Yii::t('app', 'There are no waiting for approve') ?></td>
                        </tr>
                    <?php
                    }
                    ?>
            ...
            <table class="" style="width:100%;">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                            <td colspan="9" class="col-12 mt-20 font-size-14 text-secondary"> <?= Yii::t('app', 'There are no waiting for approve') ?>
                                KPI</td>
                        </tr>
                    <?php
                    }
