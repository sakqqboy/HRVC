    ...
    <div class="col-12 border-left-dash mb-30">
        ...
        <div class="col-12 pr-10 mr-10  pb-10" style="background-color:#F5F5F5;border-radius:5px;">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-12 pt-15 pl-20">
                    ...
                    <span class="text-dark font-size-14"> <?= $kpiName ?><span class="text-secondary font-size-12">
                            &nbsp;<?= number_format($fileSize, 2) ?> mb</span></span>
                </div>
                        ...
                        <div class="pr-10 mr-10 mt-10 pb-10" style="background-color:#F5F5F5;border-radius:5px;">
                            <div class="row">
                                <div class="col-lg-7 col-md-6 col-12 pt-15">
                                    <img src="<?= Yii::$app->homeUrl ?>image/pdf.png" class="pdf-down">
                                    <span class="text-dark"> <?= $data["file"] ?> <span
                                            class="text-secondary font-size-12">&nbsp;<?= number_format($fileSize, 2) ?>
                                            mb</span></span>
                                </div>
                                <div class="col-lg-5 col-md-6 col-12 pt-15 text-end " style="text-indent: 0px;">
                                    <a href="<?= Yii::$app->homeUrl . $data['file'] ?>" target="_blank"
                                        class="btn btn-outline-secondary mr-5 btn-sm">
                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                    </a>
                                    <a href="<?= Yii::$app->homeUrl . $data['file'] ?>"
        ...
        <div class="col-12 pl-30">
            ...
            <div class="col-12 card-dashed-gray">
                ...
                <span class="font-size-14"><?= $profile['employeeFirstname'] ?>
                    <?= $profile['employeeSurename'] ?></span>
                ...
                <div class="col-12 mt-20">
                    <div class="input-group pr-20">
                        ...
                        <a href="javascript:answerKpiIssue(<?= $kpiIssueId ?>)"
                            class="btn btn-primary font-size-13 pt-8">
