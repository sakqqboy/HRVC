...
<div class="modal fade" id="delete-kpi" tabindex="-1" aria-labelledby="staticBackdrop4Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 8px; padding: 20px;">
            ...
            <div class="modal-footer justify-content-end" style="border-top: none; padding-top: 20px;">
                ...
                <input type="hidden" id="kpiId-modal" value="">
                <a href="javascript:deleteKpi()" class="btn btn-outline-danger"
