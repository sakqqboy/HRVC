<div class="modal fade" id="create-kpi-modal" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="height: 100px;margin-top:-10px">
                <h5 class="modal-title text-primary" id="staticBackdropLabel"><i class="fa fa-magic"
                        aria-hidden="true"></i> Create KPI</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-6 font-size-14">
                        <div class="col-12">
                            <label for="exampleFormControlInput1" class="form-label"><strong class="red">*</strong>KPI
                                Contents</label>
                            <input type="text" class="form-control" placeholder="" name="kpiName">
                        </div>
                        <div class="col-12 mt-10">
                            <label for="input" class="form-label"><strong class="red">*</strong> Company</label>
                            <select class="form-select" id="companyId" required name="companyId"
                                onchange="javascript:companyMultiBrach()">
                        ...
                        <div class="col-12 mt-10">
                            <div class="row">
                                <div class="col-12 border-bottom">
                                    <label for="input" class="form-label"><strong class="red">*</strong> Select
                                        Period</label>
                                </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" aria-label="" class="form-control font-size-12 "
                                                id="nextCheckDate-create" required name="nextDate">
                                        </div>
                                    </div>
                                </div>
                            </div>
