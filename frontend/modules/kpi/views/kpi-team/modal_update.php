<div class="modal fade" id="update-kpi-modal-team" tabindex="-1" aria-labelledby="staticBackdropLabel2" aria-hidden="true">
		...
		<div class="modal-content">
			<div class="modal-header" style="height: 100px;margin-top:-10px">
				<h5 class="modal-title text-primary" id="staticBackdropLabel2">
					<i class="fa fa-magic" aria-hidden="true"></i> Update <span id="team-name"></span> KPI
				</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="col-12 font-b" style="margin-top: -35px; padding-left:20px; font-size: 16px;">
				<i class="fa fa-flag" aria-hidden="true"></i> KPI : :<span class="ml-10" id="kpi-name"></span>
			</div>
			<div class="modal-body">
				<div class="col-12">
					<div class="col-12">
						<label for="exampleFormControlTextarea1" class="form-label font-size-13"> kpi Description</label>
						<div class="col-12 border pt-5 pl-10 pb-5 text-secondary" style="min-height: 100px;border-radius:5px;" id="kpi-detail"></div>
					</div>
					<div class="col-12 mt-10">
						<label for="exampleFormControlTextarea1" class="form-label font-size-13"> Team Remark</label>
						<div class="col-12 border  pt-5 pl-10 pb-5 text-secondary font-size-12" style="min-height: 50px;border-radius:5px;" id="kpi-remark"></div>
					</div>
					<div class="row">
