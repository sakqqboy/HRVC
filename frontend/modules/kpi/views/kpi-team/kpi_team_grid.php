                ...
                ?>
                        <div class="col-12 mt-10 mb-5 pim-big-box pim-<?= $colorFormat ?>" id="kpi-team-<?= $kpiTeamId ?>">
                            <div class="d-flex justify-content-start align-content-start">
                                                    ...
                                                    <div class="d-flex justify-content-start">
                                                        <div
                                                            ...
                                                            if ($role <= 4) {
                                                                ...
                                                                $url = Yii::$app->homeUrl . 'kpi/kpi-team/kpi-team-history/' . ModelMaster::encodeParams([
                                                                    'kpiTeamId' => $kpiTeamId,
                                                                    'kpiTeamHistoryId' => 0,
                                                                    'kpiId' => $kpi["kpiId"],
                                                                    'openTab' => 1
                                                            ...
                                                            <a href="<?= $url ?>"
                                                                ...
                                                                style="<?= (($kpi["countTeamEmployee"] == 0 || $colorFormat == 'disable') && $role <= 4) ? 'pointer-events: none; color: black; text-decoration: none;' : '' ?>">
                                                                <?= $textAssign ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-start">
                                                        <div
                                                            ...
                                                            if ($role <= 4) {
                                                                ...
                                                                $assignImg = "view";
                                                                if ($kpi["countTeam"] == 0 && $colorFormat == 'disable') {
                                                                    $textAssign = "Not Assign";
                                                                    $url = '#';
                                                                }
                                                            } else {
                                                            ...
                                                            <a href="<?= $url ?>"
                                                                class="font-<?= $yellow == 1 ? 'black' : $colorFormat ?>"
                                                                style="<?= (($kpi["countTeam"] == 0 || $colorFormat == 'disable') && $role <= 4) ? 'pointer-events: none; color: black; text-decoration: none;' : '' ?>">
                                                                <?= $textAssign ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="d-flex flex-column kpi-grid-2">
                                ...
                                <div class="pim-center-line-content pim-<?= $colorFormat ?>"></div>
                                <div class="d-flex flex-column kpi-grid-3">
                                    <div class="d-flex justify-content-start">
                                    ...
                                    <div class="row mt-10" style="--bs-gutter-x:0px;">
                                        <div class="col-5 text-start">
                                            ...
                                            <div class="col-12 number-pim mt-10">
                                                <?php
                                                if (!empty($kpi["target"]) && is_string($kpi["target"])) {
                                            ...
                                            <div class="row  mt-15" style="--bs-gutter-x:0px;">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <div class="col-12 text-start pim-duedate mt-5">
                                                        <?= $kpi['nextCheckDate'] == "" ? 'Not set' : $kpi['nextCheckDate'] ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <a href="<?= Yii::$app->homeUrl ?>kpi/kpi-team/kpi-team-history/<?= ModelMaster::encodeParams(['kpiTeamId' => $kpiTeamId, 'kpiTeamHistoryId' => $kpi['kpiTeamHistoryId'], 'kpiId' => $kpi["kpiId"], 'openTab' => 1]) ?>"
                                        ...
                                        <a href="<?= Yii::$app->homeUrl ?>kpi/kpi-team/kpi-team-history/<?= ModelMaster::encodeParams(['kpiTeamId' => $kpiTeamId, 'kpiTeamHistoryId' => $kpi['kpiTeamHistoryId'], 'kpiId' => $kpi["kpiId"], 'openTab' => 3]) ?>"
                                            class="<?= $colorFormat == 'disable' ? 'pim-btn-disable' : 'pim-btn' ?> mr-3"
                                            style=" <?= $colorFormat == 'disable' ? 'pointer-events: none; opacity: 0.5;' : '' ?>">
                                            <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/comment.svg" alt="Chats"
                                                class="pim-action-icon mr-3"><?= Yii::t('app', 'Chats') ?>
                                        </a>
                                        <a href="<?= Yii::$app->homeUrl ?>kpi/kpi-team/kpi-team-history/<?= ModelMaster::encodeParams(['kpiTeamId' => $kpiTeamId, 'kpiTeamHistoryId' => $kpi['kpiTeamHistoryId'], 'kpiId' => $kpi["kpiId"], 'openTab' => 4]) ?>"
                                            class="<?= $colorFormat == 'disable' ? 'pim-btn-disable' : 'pim-btn' ?> mr-3"
                                            style=" <?= $colorFormat == 'disable' ? 'pointer-events: none; opacity: 0.5;' : '' ?>">
