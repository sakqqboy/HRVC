<div class="d-flex header-filter-pim">
    <div class="pim-head-upderline d-flex align-items-start justify-content-start">
        ...
        <div class="pim-type-box" <a href="<?= Yii::$app->homeUrl ?>kgi/kgi-team/team-kgi-grid"
            style="text-decoration: none;color: #3C3D48;">
            <span>
        ...
        <div class="pim-center-line"></div>
        <div class="header-kpi-active" style="min-width:235px;">
            <a href="<?= Yii::$app->homeUrl ?>kpi/kpi-team/team-kpi-grid" style="text-decoration: none;color: #30313D;">
                <span>
