			...
			<div class="row">
				...
				<div class="col-lg-1 col-md-6 col-12 pr-0 text-end">
					<div class="btn-group" role="group">
						<a href="<?= Yii::$app->homeUrl ?>kpi/kpi-team/team-kpi-grid" class="btn btn-outline-primary font-size-12 pim-change-mode">
							<i class="fa fa-th-large" aria-hidden="true"></i>
						</a>
						<a href="<?= Yii::$app->homeUrl ?>kpi/kpi-team/team-kpi" class="btn btn-primary font-size-12 pim-change-mode">
