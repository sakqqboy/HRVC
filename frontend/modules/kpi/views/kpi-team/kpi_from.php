...
$this->title = Yii::t('app', 'Update Team KPI');
            ...
            <div class="row" style="--bs-gutter-x:0px;">
                <div class="col-6 align-content-center">
                    ...
                    <div class="pim-name-title" style="display: flex; align-items: center; gap: 14px;">
                        <a href="<?= isset(Yii::$app->request->referrer) ? Yii::$app->request->referrer : Yii::$app->homeUrl . 'kpi/kpi-team/team-kpi-grid' ?>" style="text-decoration: none; width:70px; height:26px;" class="btn-create-branch">
                                ...
                                <div class="d-flex flex-grow-1 justify-content-center">
                                    <div class="yenlow-assignKFI">
                                        ...
                                        <a href="<?= Yii::$app->homeUrl ?>kpi/assign/assign/<?= ModelMaster::encodeParams(['kpiId' => $data["kpiId"], "companyId" => $company["companyId"]]) ?>"
                                            ...
                                            <?= count($data['kpiEmployee']) == 0 ?  Yii::t('app', 'Assign Person') :  Yii::t('app', 'Assigned Person'); ?>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-12 pl-30">
                        ...
                        <div class="form-group start-center mt-42" style="  gap: 14px;">
                            ...
                            <div class="between-center" style="width: 100%; ">
                                ...
                                <div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
                                    <label class="switch">
                                        <input type="checkbox" id="override-checkbox-kpi-team" checked
