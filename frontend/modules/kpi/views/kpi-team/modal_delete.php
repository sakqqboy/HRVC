<!-- <div class="modal fade" id="delete-kpi-team-team" tabindex="-1" aria-labelledby="staticBackdrop5" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="row text-center mt-20" style="border-bottom:none;">
				...
				<div class="col-6 text-start">
					...
					<a href="javascript:deleteKpiTeam()" class="btn btn-danger" style="width: 100px;">Delete</a>
					<div class="mt-40"></div>
				</div>
			</div>
		</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 8px; padding: 20px;">
            ...
            <div class="modal-body text-start" style="font-size: 14px; color: #6c757d; padding-top: 10px;">
                Deleting this KPI will remove all assigned employee teams and their history. You can recover this
