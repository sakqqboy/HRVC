                ...
                ?>
                        <div class="col-6 mb-15">
                            <div class="small-content-pim bg-white" style="cursor: pointer;"
                                ...
                                <div class="border-left align-content-center pr-0"
                                    style="font-weight: 400;width:20%;justify-items: center;">
                                    <a href="javascript:void(0);"
                                        onclick="event.stopPropagation(); kpiTeamHistoryView(<?= $kpiId ?>, <?= $teamId ?>)"
                                        class="doubleplay-btn flex-all-center ml-5">
                                        ...
                                        <div class="small-content-pim" style="height:60px;">
                                            <div class="row" style="--bs-gutter-x:0px;width:100%;">
                                                <div class="col-2 pr-0 pl-0 text-center align-content-center">
                                                    <img src="<?= Yii::$app->homeUrl ?><?= $em['picture'] ?>"
                                                        class="pim-image-AssignMembers">
                                                </div>
