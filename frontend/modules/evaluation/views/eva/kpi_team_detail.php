		...
		<div class="modal-content">
			<div class="modal-header" style="border: none;">
				<div class="modal-title flag-Backdrop7" id="exampleModalViewkpi3Label">
					...
					<span class="ml-10" id="kpi-name-view-kpi-team"></span>
				</div>
				<div class="modal-title border Completed-Backdrop7 badge rounded-pill bg-warning text-dark" id="status-view"></div>
				<span class="border border-1 border-deadline-Backdrop7">Deadline <span class="font-size-10 text-dark pr-10"> : <span id="period-date-view-kpi-team"></span></span></span>
			</div>
			<div class="col-12 text-end">
				<span class="border border-1 border-next-Backdrop7">Next Update <span class="font-size-10 text-dark pr-10"> : <span id="next-date-view-kpi-team"></span></span></span>
			</div>
			...
			<div class="modal-body">
					...
					<div class="row mt-20">
						...
						<div class="col-lg-2 col-md-6 col-3">
							...
							<div class="col-12 diamond-con-Backdrop3">
								<i class="fa fa-diamond mr-5" aria-hidden="true"></i> <span id="quantRatio-view-kpi-team"></span>
							</div>
						</div>
						...
						<div class="col-3 text-center">
							...
							<div class="col-12 million-number-Backdrop3">
								<span id="target-view-kpi-team"></span>
							</div>
						</div>
						<div class="col-2">
							<div class="col-12 padding-mark-Backdrop3 mt-15 text-center">
								<span id="code-view-kpi-team" class="font-b"></span>
							</div>
						</div>
						<div class="col-3 text-center">
							...
							<div class="col-12 million-number-Backdrop3">
								<span id="result-view-kpi-team"></span>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-2">
							<div class="col-12" style="margin-left:-70px !important; margin-top:-40px;">
								...
								<div class="circle-Priority" id="prirority-view-kpi-team"></div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 col-6">
							...
							<div class="col-12 update-mouth-Backdrop3">
								<i class="fa fa-calendar mr-7" aria-hidden="true"></i> <span id="unit-view-kpi-team"></span>
							</div>
						</div>
						<div class="col-lg-5 col-md-6 col-6 mt-10">
							<div class="col-12">
								<div class="progress">
									<div class="progress-bar" id="percentRatio-kpi-team" style="background:#2F80ED;margin-left:-50px;height:13px;"></div>
									<span class="badge rounded-pill pro-load-Backdrop7" id="ratio-view-kpi-team"></span>
								</div>
							</div>
						</div>
						<div class="mt-5"></div>
				...
				<div class="col-12 detailsDescription-Backdrop3 pl-20" id="decription-view-kpi-team">
