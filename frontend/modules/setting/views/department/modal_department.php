        ...
        <div class="flex-grow-1  ms-2">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="city-crad-company  mt-12  justify-content-start pt-0 pb-0 align-content-center d-inline-flex font-size-14" style="height: 27px;font-weight:400;line-height: 20px;">
                        <img src="<?= Yii::$app->homeUrl ?><?= $branches['branchImage'] ?>" alt="icon" class="bangladresh-hrvc">
                        <?= Yii::t('app', $branches['branchName']) ?>
                    </div>
                    <div class="mt-12 pt-0 pb-0" style="height: 27px;">
                        <div class="city-crad-company  justify-content-start pt-0 pb-0 align-content-center d-inline-flex font-size-14" style="height: 27px;font-weight:400;line-height: 20px;">
                            <img src=" <?= Yii::$app->homeUrl ?><?= $branches['flag'] ?>"
