<div style="width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; gap: 21px;">
    ...
    <button type="button" class="btn-previous<?= ($numPage['nowPage'] == 1 ? '-disable' : '') ?>"
        ...
        onclick="  goToPageDepartment(<?= $numPage['nowPage'] - 1 ?>, '<?php echo $page ?>', <?php echo $countryId ?>, <?php echo $branchId ?>  )">
    ...
    <div>
        ...
        <a href="javascript:void(0);"
            onclick="  goToPageDepartment(1, '<?php echo $page ?>', <?php echo $countryId ?>, <?php echo $branchId ?>  )"
    ...
    if(($numPage['nowPage'] == 1 || $numPage['nowPage'] == 3) && $numPage['totalPages'] != 2 && $numPage['totalPages'] < 4 ){
        ?>
    <a href="javascript:void(0);"
        onclick="  goToPageDepartment(2, '<?php echo $page ?>', <?php echo $countryId ?>, <?php echo $branchId ?>  )"
    ...
    <div class="d-flex align-items-center">
        ...
        ?>
        <!-- . . . ซ้าย -->
        <span class="mr-15" id="page-jump-ellipsis" style="cursor: pointer; font-weight: 500;">...</span>
        ...
        <div>
            <a href="javascript:void(0);"
                onclick="  goToPageDepartment(<?php echo $numPage['nowPage'] ?>, '<?php echo $page ?>', <?php echo $countryId ?>, <?php echo $branchId ?> )"
    ...
    <div>
        <!-- Page Numbers สุดท้าย-->
        <a href="javascript:void(0);"
            onclick="  goToPageDepartment(<?php echo $numPage['totalPages'] ?>, '<?php echo $page ?>', <?php echo $countryId ?> , <?php echo $branchId ?>)"
    ...
    <button type="button" class="pt-3 btn-next<?= ($numPage['nowPage'] == $numPage['totalPages'] ? '-disable' : '') ?>"
        ...
        onclick="  goToPageDepartment(<?php echo $numPage['nowPage'] + 1 ?>, '<?php echo $page ?>', <?php echo $countryId ?> , <?php echo $branchId ?> )"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener("click", function(event) {
        ...
        if (!isClickInside) {
            ...
            if (nextPage) {
                goToPageDepartment(nextPage, '<?= $page ?>', <?= $countryId ?>, <?php  $branchId ?>);
            }
        }
        ...
        if (!isClickInside2) {
            ...
            if (nextPage2) {
                goToPageDepartment(nextPage2, '<?= $page ?>', <?= $countryId ?>, <?php  $branchId ?>);
            }
        }
    });
