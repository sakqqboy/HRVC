...
<div class="col-12 department-one" style="margin-top: 90px;">
	<div class="row ">
		...
		<div class="col-12 mt-10">
			<a href="<?= Yii::$app->homeUrl ?>setting/team/export" class="no-underline text-primary" target="_blank">
				&nbsp;> > > Team format file < < <&nbsp;</a>
		</div>
		<div class="col-4 mt-20 border-right border-bottom pt-10" style="min-height:150px;">
			<div class="mb-3">
				<label for="formFile" class="form-label">Default file input example</label>
				<input class="form-control mt-10" type="file" id="formFile" name="teamFile">
			</div>
			<div class="col-12 text-end mt-10">
				<a href="<?= Yii::$app->homeUrl ?>setting/team/create/<?= ModelMaster::encodeParams(["companyId" => '']) ?>" class="btn btn-danger pull-left">
