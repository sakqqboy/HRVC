                    ...
                    <table id="myTable" class="table align-middle table-spacing">
                        ...
                        <tbody>
                            ...
                            <tr class="tr-font list-table-body" id="department-<?= $team['teamId'] ?>">
                                ...
                                <td>
                                    <a onclick="openPopupModalDepartment('<?= Yii::$app->homeUrl ?>setting/department/modal-department/<?= ModelMaster::encodeParams(['branchId' => $data['branchId'], 'departmentId' => $data['departmentId']]) ?>')"
