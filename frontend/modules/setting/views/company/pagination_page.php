<div style="width: 100%; text-align: center; display: flex; justify-content: center; align-items: center; gap: 21px;">
    ...
    <?php 
            if ($numPage['nowPage'] <= 3 ) { 
                ...
                ?>
    <a href="javascript:void(0);" onclick="goToPageCompany(2, '<?php echo $page ?>', <?php echo $countryId; ?>)"
    ...
    <?php 
            ...
            ?>
    <a href="javascript:void(0);" onclick="goToPageCompany(3, '<?php echo $page ?>', <?php echo $countryId; ?>)"
    ...
    <a href="javascript:void(0);"
        onclick="goToPageCompany(<?php echo $numPage['nowPage']; ?>, '<?php echo $page ?>', <?php echo $countryId; ?>)"
    ...
    <a href="javascript:void(0);"
        onclick="goToPageCompany(<?php echo $numPage['totalPages'] - 2 ?>, '<?php echo $page ?>', <?php echo $countryId; ?>)"
    ...
    <a href="javascript:void(0);"
        onclick="goToPageCompany(<?php echo $numPage['totalPages'] - 1 ?>, '<?php echo $page ?>', <?php echo $countryId; ?>)"
    ...
    <a href="javascript:void(0);"
        onclick="goToPageCompany(<?php echo $numPage['totalPages'] ?>, '<?php echo $page ?>', <?php echo $countryId; ?>)"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener("click", function(event) {
        ...
        if (!isClickInside) {
            ...
            if (nextPage) {
                goToPageCompany(nextPage, '<?php echo $page ?>', <?php echo $countryId; ?>);
            }
        }
