...
<div class="contrainer-body mt-33" style="padding-bottom: 31px; ">
    ...
    <div class="company-group-edit mt-30">
        ...
        <div class="row mt-40">
            <div class="col-lg-4 col-md-6 col-12 in-for">
                ...
                <div class="row mt-30">
                    ...
                    <div class="col-lg-8 col-md-6 col-12 name-head0 d-flex align-items-center">
                        <span class="text-primary address-box0  pr-5"><?= $company["email"] ?></span>
                    ...
                    <div class="col-lg-8 col-md-6 col-12 name-head0 mt-7 d-flex align-items-center">
                        <span class="text-primary address-box0  pr-5"><?= $company["contact"] ?></span>
                        <img src="<?= Yii::$app->homeUrl ?>image/coppy.svg"
                    ...
                    <div class="col-lg-8 col-md-6 col-12 name-head0 mt-7">
                        <span class="text-primary address-box0"><?= $company["website"] ?></span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 in-for">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <i class="fa fa-users" aria-hidden="true"
                                    style="font-size: 32px;padding-top: 15px;"></i>
                            </div>
                            <div class="col-2">
