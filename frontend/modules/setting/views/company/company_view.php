    ...
    <div class="row pt-50">
        ...
        <div class="col-lg-5 col-md-6 col-12 tcg-edit0 mt-40">
            ...
            <a href="<?= Yii::$app->homeUrl ?>setting/company/update-company/<?= ModelMaster::encodeParams(['companyId' => $company['companyId']]) ?>"
                class="btn btn-primary  ml-10" style="margin-top: -20px;"><i class="fa fa-pencil"
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-12 in-for">
            ...
            <div class="row mt-30">
                ...
                <div class="col-lg-6 col-md-6 col-12 name-head0 mt-10">
                    <span class="text-primary address-box0"><?= $company["website"] ?></span> <i
                        class="fa fa-clipboard clipboard0" aria-hidden="true"></i>
                </div>
            </div>
        </div>
