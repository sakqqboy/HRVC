				...
				<div class="avatar-preview" style="background-color:white;">
					<div id="imagePreview">
						...
						if ($company["picture"] != null) { ?>
							<img src="<?= Yii::$app->homeUrl . $company['picture'] ?>" class="company-group-picture" id="old-image">
						<?php
						} else { ?>
			...
			<div class="col-lg-6 col-md-6 col-12">
				<div class="col-12 mt-40">
					<div class="row">
						...
						<div class="col-9">
							<input type="text" class="form-control" name="displayName" value="<?= $company['displayName'] ?>" required>
						</div>
						<div class="mt-20"></div>
						<div class="col-3  pl-30">
							Website </div>
						...
						<div class="col-9">
							<input type="text" class="form-control" name="location" required value="<?= $company['location'] ?>">
						</div>
						<div class="mt-20"></div>
						<div class="col-12">
							<div class="row">
								...
								<div class="col-4">
									<input type="text" class="form-control" name="industries" required value="<?= $company['industries'] ?>">
								</div>
								<div class="col-2">
								...
								<div class="col-4">
									<input type="text" name="founded" class="form-control" value="<?= $company['founded'] ?>">
								</div>
								<div class="col-2">
								...
								<div class="col-4">
									<input type="text" class="form-control" name="director" required value="<?= $company['director'] ?>">
								</div>
								<div class="col-2">
									Social Tag
								</div>
								<div class="col-3">
									<input type="text" name="socialTag" class="form-control" value="<?= $company['socialTag'] ?>">
								</div>
							</div>
						</div>
					</div>
