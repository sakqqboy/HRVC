...
document.addEventListener("click", function(event) {
    ...
    if (!isClickInside) {
        ...
        if (nextPage) {
            // goToPageTitle(nextPage, '<?= $page ?>', <?php  $departmentId ?>,
            //     <?php  $companyId ?>, <?php  $branchId ?>);
            goToPageTitle(nextPage, '<?php echo $page ?>',
    ...
    if (!isClickInside2) {
        ...
        if (nextPage2) {
            // goToPageTitle(nextPage2, '<?= $page ?>', <?php  $departmentId ?>,
            //     <?php  $companyId ?>, <?php  $branchId ?>);
            goToPageTitle(nextPage2, '<?php echo $page ?>',
                <?php echo $departmentId ?>, <?php echo $companyId ?>, <?php echo $branchId ?>);
        }
    }
});
