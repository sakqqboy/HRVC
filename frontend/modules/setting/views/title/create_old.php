    ...
    <div class="col-12 mt-40 pl-20 pr-20">
        <div class="row ">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="col-12">
                    <label class="form-label font-size-12 font-b"><span class="text-danger mr-5"><b>*</b></span>Select
                        Associate Layer</label>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="col-12">
                    <label class="form-label font-size-12 font-b"><span class="text-danger mr-5"><b>*</b></span>Shot Tag
                    </label>
                    <input type="text" name="shortTag" id="shortTag" class="form-control" required>
                </div>
            </div>
            <div class="col-lg-3 col-6 mt-10">
                <label class="form-label font-size-12 font-b"><span class="text-danger mr-5"><b>*</b></span>Company
                </label>
            ...
            <div class="col-lg-3 col-6 mt-10">
                <label class="form-label font-size-12 font-b"><span class="text-danger mr-5"><b>*</b></span>Branch
                </label>
            ...
            <div class="col-lg-3 col-6 mt-10">
                <label class="form-label font-size-12 font-b"><span class="text-danger mr-5"><b>*</b></span>Department
                </label>
                <select class="form-select" name="departmentId" id="department-team" required
                    onchange="javascript:addDepartmentId()">
            ...
            <div class="col-12 mt-10">
                ...
                <textarea name="jobDescription" id="jobDescription" class="form-control"
            ...
            <div class="col-12 mt-10">
                ...
                <textarea name="purpose" id="purpose" class="form-control"
                    style="white-space: pre-wrap;height:150px;"></textarea>
            </div>
            <div class="col-12 mt-10">
                <label class="form-label font-size-12 font-b">Key Responsibility</label>
                <textarea name="keyResponsibility" id="keyResponsibility" class="form-control"
                    style="white-space: pre-wrap;height:150px;"></textarea>
            </div>
            <div class="col-12 mt-10">
                ...
                <div class="col-12">
                    <div class="tags-input">
                        <div id="tags" class="">
                            ...
                            <input type="text" id="input-tag" class="border form-control mt-10"
                                placeholder="Add required skill(s)">
                        </div>
                    </div>
                </div>
