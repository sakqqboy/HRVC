<div class="modal fade pr-0 pl-0" id="warning-delete-employee" tabindex="-1" aria-labelledby="staticBackdrop4Label"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered pr-0 pl-0" style="margin-left:750px;">
        <div class="modal-content" style="border-radius: 8px; padding: 10px 10px 20px 10px;">
            <div class="modal-header" style="width:100%;border-bottom: none; padding-bottom: 0;">
                ...
                <button type="button" class="btn-close pull-right" style="margin-top: -2px;" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body text-start" style="font-size: 14px; color: #6c757d; padding-top: 10px;">
                <?= Yii::t('app', "You are about to delete the employee(s). If you proceed, all associated data will also be permanently deleted 
            ...
            <div class="d-flex justify-content-end pr-20" style="width:100%;border-top: none; padding-top: 20px;">
                <a class="btn btn-primary me-2 d-flex justify-content-center align-content-center"
                ...
                <a class="btn btn-outline-danger" style="min-width: 100px;font-weight:500;"
                    onclick="javascript:deleteMultiEmployee()"
