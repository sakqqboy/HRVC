            ...
            <div>
                ...
                <div class="between-center">
                    ...
                    <div class="d-flex align-items-center" style="gap: 10px;">
                        ...
                        <select class="form-control select-employee-status" aria-label="Default select example" name="status"
                        ...
                        <div class="d-flex justify-content-start" style="gap: 27px;">
                            <div>
                                ...
                                <div class="input-group">
                                    <span class="input-group-text" style="background-color: white; border-right: none;padding:3px 10px;width:clamp(35px, 2.56vw, 70px);">
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control font-size-14" id="employeeId" name=" employeeId"
                                    ...
                                    value="<?= $employee['employeeId'] ?? '' ?>" style="width:clamp(325px, 23.79vw, 560px);">
                            </div>
                        </div>
                        <div class="d-flex justify-content-start" style="gap: 27px;">
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control font-size-14" name="password"
                                        ...
                                        style="width:clamp(255px, 18.66vw, 560px);border-left: none; border-right: none;" required>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select font-size-14" style="width:clamp(290px, 21.22vw, 560px); border-left: none;"
