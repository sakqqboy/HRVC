...
<div class="company-group-body mt-50 border" style="margin-left: -30px;margin-right: -30px;">
    <div class=" company-group-edit bg-white">
        ...
        <div class="row update-company-body mt-20" style="--bs-gutter-x:0px;">
            <!-- Account Details -->
            <div>
                <!-- head -->
                ...
                <div class="between-center mt-12 border-top pt-20 justify-content-start" style="gap:15px;">
                    ...
                    <div class="vertical-line" style="height: 430px;"></div>

                    <!-- <div class="start-center" style="width: 822px; gap: 34px;"> -->
                    <div class="start-center flex-grow-1" style="gap: 30px;">
                        <div class="d-flex justify-content-start" style="gap: 27px;">
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control font-size-14" id="mailId" name="mailId"
                                        placeholder="sample@email.com" value="<?= $userEmployee['mailId'] ?? '' ?>"
                                        <?= $isDisabled ? 'readonly' : '' ?>
                            ...
                            <div>
                                ...
                                <input type="text" class="form-control font-size-14" id="employeeId" name=" employeeId"
                                    ...
                                    style="width:clamp(325px, 23.79vw, 560px);">
                            </div>
                        </div>
                        <div class="d-flex justify-content-start" style="gap: 27px;">
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" id="password-hash" value="<?= $statusfrom == 'Update' ? $userEmployee['password'] : '' ?>">
                ...
                <div class="d-flex flex-column" style="gap: 40px">
                    ...
                    <div class="row">
                        <div class="col-4 d-flex flex-column" style="gap: 12px;">
                            ...
                            <div class="input-group">
                                <select id="teamSelectId" class="form-select"
                                    style="border-right: none; width: 239px; appearance: none; background-image: none;"
            ...
            <div class="mt-60">
                ...
                <div class="d-flex flex-column align-items-end w-100" style="gap: 20px;">
                    ...
                    <!-- ✅ ปุ่ม Cancel + Save -->
                    <div class="d-flex justify-content-end align-items-center" style="gap: 10px;">
                        <input type="hidden" value="<?= $statusfrom ?>" id="status-form">
                        ...
                        <?php if ($statusfrom == 'Update') { ?>
                            ...
                            <button type="submit" class="btn-save-group" id="update-employee">
    ...
    <script>
        ...
        $(function() {
            $('#deleteLanguageBtn').on('click', function(e) {
                e.preventDefault();
                const userId = $(this).data('user-id') || '';
                const employeeId = $('#emId').val();
                const languageId = $('#mainLanguage').val() || '';
                const level = $('#lavelLanguage').val() || '';
                const csrfParam = $('meta[name="csrf-param"]').attr('content');
                const csrfToken = $('meta[name="csrf-token"]').attr('content');

                const url = $url + 'setting/employee/delete-language';

                // ส่ง ajax แบบ form-encoded (ง่าย)
                const postData = {
                    id: employeeId,
        ...
        function toggleDeleteButton() {
            ...
            if (!mainVal) {
                $('#deleteLanguageBtn').hide();
                $('#flag-ml').attr('src', '<?= Yii::$app->homeUrl ?>image/e-world.svg');
            } else {
                $('#deleteLanguageBtn').show();
            }
            if (!mainVal1) {
            ...
            if (!mainVal2) {
                $('#deleteLanguageBtn-2').hide();
                $('#flag-ml2').attr('src', '<?= Yii::$app->homeUrl ?>image/e-world.svg');
            } else {
                $('#deleteLanguageBtn-2').show();
            }
        }

        // ✅ ตรวจทุกครั้งที่มีการเปลี่ยน select ใด select หนึ่ง
        $('#mainLanguage, #lavelLanguage').on('change', function() {
            toggleDeleteButton();
        });
