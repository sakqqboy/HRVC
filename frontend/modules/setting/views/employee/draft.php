					...
					if (isset($employees) && count($employees) > 0) {
						foreach ($employees as $employeeId => $employee) : ?>
							...
							<tr class="employee-tr" id="employee-<?= $employeeId ?>">
								...
								<td style="width:5%;border:0px !important;" class="pl-0 pr-0">
									<div class="col-12 border-right-radius-table justify-content-center " style="height:48px;">
