	...
	<div class="row">
		...
		<div class="col-lg-9 col-12 text-end">
			...
			<div class="btn-group ml-10" role="group" aria-label="Basic example">
				<button type="button" class="btn btn-primary font-size-12 <?= $status == 0 ? '' : 'btn-curr' ?>" id="btn-0" onclick="javascript:employeeType(0)">All</button>
				<button type="button" class="btn btn-primary font-size-12 <?= $status == 1 ? '' : 'btn-curr' ?>" id="btn-1" onclick="javascript:employeeType(1)"><i class="fa fa-briefcase" aria-hidden="true"></i> Current</button>
				<button type="button" class="btn btn-primary font-size-12 <?= $status == 2 ? '' : 'btn-curr' ?>" id="btn-2" onclick="javascript:employeeType(2)">Resigned <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></button>
		...
		<div class="col-lg-3 col-md-4 col-6 mt-10">
			<div class="input-group">
				...
				<select class="form-control font-size-12" id="branch-team" onchange="javascript:departmentBranch()" <?= $branchId == '' ? 'disabled' : '' ?>>
					<?php
					if ($branchId != '') { ?>
		...
		<div class="col-lg-3 col-md-4 col-6 mt-10">
			<div class="input-group">
				...
				<select class="form-control font-size-12" id="department-team" onchange="javascript:teamDepartment()" <?= $departmentId == '' ? 'disabled' : '' ?>>
					<?php
					if ($departmentId != '') { ?>
		...
		<div class="col-lg-3 col-md-4 col-6 mt-10">
			<div class="input-group">
				...
				<select class="form-control font-size-12" id="team-department" <?= $teamId == '' ? 'disabled' : '' ?>>
					<?php
					if ($teamId != '') { ?>
