    ...
    <div class="alert example-2 scrollbar-ripe-malinka alert-create0" role="alert">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12  mt-10">
                        ...
                        <input type="text" class="form-control font-size-14" name="lastName" required
                            value="<?= $employee['employeeSurename'] ?>">
                    </div>
                    <div class="col-lg-4 col-md-6 col-12  mt-10">
                        <label class="form-label font-size-13"><strong class="text-danger">*</strong> Employee
                            Number</label>
                        <input type="text" class="form-control font-size-14" name="employeeNumber" required
                            value="<?= $employee['employeeNumber'] ?>">
                    </div>
                    <div class="col-lg-4 col-md-6 col-12  mt-10">
                        <label class="form-label font-size-13"><strong class="text-danger">*</strong> Joining
                            Date</label>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mt-10">
                        ...
                        <select class="form-select font-size-14" name="nationality">
                            ...
                            <option value="<?= $oldData['nationality']['id'] ?>"><?= $oldData['nationality']['name'] ?>
                            </option>
                            <?php
							}
							?>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <select class="form-select font-size-14" id="company-team" name="company"
                    onchange="javascript:branchCompany()">
                    <?php
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <select class="form-select font-size-14" id="branch-team" name="branch"
                    onchange="javascript:departmentBranch()">
                    <?php
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <select class="form-select font-size-14" name="department" id="department-team"
                    onchange="javascript:teamDepartment()">
                    <?php
            ...
            <div class="col-lg-3 col-md-6 col-12 mt-10">
                ...
                <select class="form-select font-size-14" name="teamPosition" id="team-position">
                    ...
                    <option value="<?= $oldData['teamPosition']['id'] ?>"><?= $oldData['teamPosition']['name'] ?>
                    </option>
                    <?php
					}
					?>
                    ...
                    <div class="dashed">
                        <div class="row pt-10 pb-10">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 " style="border-right:lightgray solid thin;">
                                ...
                                <div class="text-secondary font-size-14">Supported Files <span
                                        class="text-dark font-size-10"> - .pdf, .doc, .docx</span></div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12 text-center pt-20">
								...
								if ($employee['resume'] != null) {
									...
									if ($type[1] != 'pdf') { ?>
                                <a href="https://view.officeapps.live.com/op/embed.aspx?src=https://tcg-hrvc-system.com/<?= $employee['resume'] ?>"
                                    target="_blank" style="text-decoration: none;">
                                    <i class="fa fa-eye mr-5" aria-hidden="true"></i>View resume
                                </a>
                                <?php
									} else { ?>
                                <a href="<?= Yii::$app->homeUrl . $employee['resume'] ?>" target="_blank"
								...
								?>
                                <div class="col-12 mt-5 text-center font-size-12 font-b text-default">File not found
                                </div>
                                <?php
								}
                            ...
                            <div class="col-lg-4 col-md-6 col-12 text-center pt-8">
                                ...
                                <div class="col-12 mt-10">
									...
									if ($employee['employeeAgreement'] != null) {
										...
										if ($type[1] != 'pdf') { ?>
                                    <a href="https://view.officeapps.live.com/op/embed.aspx?src=https://tcg-hrvc-system.com/<?= $employee['employeeAgreement'] ?>"
                                        target="_blank" style="text-decoration: none;">
                                        <i class="fa fa-eye mr-5" aria-hidden="true"></i>View Agreement
                                    </a>
                                    <?php
										} else { ?>
                                    <a href="<?= Yii::$app->homeUrl . $employee['employeeAgreement'] ?>" target="_blank"
                                        style="text-decoration: none;">
                                        <i class="fa fa-eye mr-5" aria-hidden="true"></i>View Agreement
                                    </a>
                                    <?php
            ...
            <div class="col-lg-6 col-md-6 col-12 pl-40">
                ...
                <div class="col-12 mt-5">
                    <textarea class="form-control" name="remark"
                        style="height:160px;"><?= $employee['remark'] ?></textarea>
                </div>
            </div>
        </div>
        <div class="col-12 mt-20 font-size-16" style="font-weight: 700;">
            ...
            <div class="col-lg-6 col-12 z-1">
                <div class="row">
                    ...
                    <div class="<?= $class ?> mt-10 font-size-14">
                        <input type="checkbox" name="role[]" class="checkbox-md mr-5" value="<?= $role['roleId'] ?>"
                            <?= $check ?>> <?= $role["roleName"] ?>
                    </div>
                    <?php
								$i++;
