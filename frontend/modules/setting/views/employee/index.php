                        ...
                        <div class="col-lg-4 col-md-6 col-12 pr-10 pl-10">
                            <div class="card employee-box" id="employee-<?= $employeeId ?>">
                                <div class="position-relative new-employee">
                                    <input type="checkbox" id="check-employee-<?= $employeeId ?>" name=""
                                        class="checkbox-employee pull-left invisible"
                                        onchange="javascript:selectEmployee(<?= $employeeId ?>)" value="<?= $employeeId ?>">
                                    <img src="<?= Yii::$app->homeUrl ?>images/employee/status/new-employee.svg"
                                        class="pull-right <?= $employee['isNew'] == 1 ? '' : 'invisible' ?>" alt="New Employee"
                                ...
                                <div class="d-flex align-items-start justify-content-between mt-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <span class="profile-employee-title">
                                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/star.svg"
                                                        class="profile-icon" style="margin-top: -3px;">
                                                    <?= $employee["titleName"] ?>
                                                </span>
                                                <span class="profile-employee-department">
                                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/share.svg"
                                                        class="profile-icon">
                                    ...
                                    <div class="position-relative">
                                        <div class="position-absolute top-0 end-0 d-flex gap-0">
                                            ...
                                            <a href="javascript:void(0);" onclick="javascript:showAction(<?= $employeeId ?>)"
                                                style="text-decoration: none;" id="show-action-box-<?= $employeeId ?>">
                                                <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/threedot.svg"
                                                    class="pim-icon">
                                            </a>
                                        </div>
                                        <div class="employee-action border" id="employee-action-<?= $employeeId ?>">
                                            <a href="<?= Yii::$app->homeUrl ?>setting/employee/update/<?= ModelMaster::encodeParams(['employeeId' => $employeeId]) ?>"
                                                ...
                                                <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/editblack.svg"
                                                    class="pim-icon" style="width:16px;height:16px;">
                                            </a>
                                            <a href="javascript:void(0);"
                                                onclick="javascript:warningDeleteEmployee(<?= $employeeId ?>)"
                                                class="icon-btn-delete mt-5">
                                                <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/bin.svg"
                                                    class="pim-icon" style="width:16px;height:16px;">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="employee-contact-box">
                                    <div class="d-flex align-items-start justify-content-start pb-10 mb-10"
                                        style="border-bottom:1px dashed  #94989C;">
                                        <div class="position-relative me-2">
                                            <img src="<?= Yii::$app->homeUrl . $employee['companyPicture'] ?>"
                                                class="rounded-circle company-img" alt="Profile">
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            <div class="d-flex align-items-start justify-content-start">
                                                ...
                                                <div class="profile-employee-email text-truncate"
                                                    ...
                                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/coppy-gray.svg"
                                                        class="profile-icon position-absolute view-cursor"
                                            ...
                                            <div class="d-flex align-items-start justify-content-start mt-12">
                                                <div class="position-relative mr-5">
                                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/tel.svg"
                                                        class="profile-icon">
                                                </div>
                                                <div class="profile-employee-tel flex-grow-1"
                                                    ...
                                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/coppy-gray.svg"
                                                        class="ml-5 profile-icon view-cursor"
                                                        onclick="javascript:copyToClipboard('<?= $employee['telephoneNumber'] ?>')"
                                                        title="<?= $employee['telephoneNumber'] ?>" style="margin-top: -3px;">
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-start justify-content-start mt-12">
                                                <div class="position-relative mr-5">
                                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/employee-gray.svg"
                                                        class="profile-icon" style="margin-top: -3px;">
                                                </div>
                                                <div class="profile-employee-number flex-grow-1"
                                                    title="<?= $employee['telephoneNumber'] ?>" style="position: relative;">
                                                    Employee ID
                                                    <span style="font-weight: 600;color:#30313D;"
                                                        class="ms-1"><?= $employee["employeeNumber"] ?></span>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-start justify-content-start mt-12">
                                                <div class="position-relative mr-5">
                                                    <img src="<?= Yii::$app->homeUrl ?>images/icons/Settings/calendar-gray.svg"
                                                        class="profile-icon" style="margin-top: -3px;">
                                                </div>
                                                <div class="profile-employee-number flex-grow-1"
                                                    title="<?= $employee['telephoneNumber'] ?>" style="position: relative;">
                                                    Employee Since
                                                    <span style="font-weight: 600;color:#30313D;"
                                                        class="ms-1"><?= $employee["joinDate"] ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
