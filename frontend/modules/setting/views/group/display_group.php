...
padding: 30px; gap: 7.721px; flex-shrink: 0;border-radius: 7.721px;border: 1.544px dashed var(--Stroke-Bluish-Gray, #BBCDDE);background: #F9F9F9;">
        ...
        <span
            class="name-full-tokyo"><?= Yii::t('app', 'Click "Group Configuration" to set up the system. All companies will be part of the group, and branches will be linked to their respective companies.') ?></span>
