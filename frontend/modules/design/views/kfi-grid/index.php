...
<div class="col-12 mt-90 pd-Performance">
    ...
    <div class="col-12 mt-20">
        ...
        <div class="alert alert-white-4">
                            ...
                            <div class="nav nav-pills" id="pills-tab" role="tablist">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <div class="nav-item" role="presentation">
                                        <a class="btn btn-light-3 font-size-13" id="pills-Sort-tab" data-bs-toggle="pill" data-bs-target="#pills-sort" type="button" role="tab" aria-controls="pills-Sort" aria-selected="true"><i class="fa fa-list-ul" aria-hidden="true"></i></a>
                                    </div>
                                    <div class="nav-item" role="presentation">
                                        <a class=" btn btn-light-3 font-size-13" id="pills-Compile-tab" data-bs-toggle="pill" data-bs-target="#pills-Compile" type="button" role="tab" aria-controls="pills-Compile" aria-selected="true"><i class="fa fa-th-large" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-pane fade show active" id="pills-Sort" role="tabpanel" aria-labelledby="pills-Sort-tab">
                <div class="col-12 scrollbar-tab">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-5 col-12 card cards-grid border">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-6">
                                ...
                                <div class="col-lg-6 col-md-6 col-6">
                                    <div class="row">
                                        <div class="col-1">
                                            <button type="button" class="btn btn-outline-secondary font-size-10"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                        </div>
                                        <div class="col-1 pl-30">
                                            <button type="button" class="btn btn-outline-danger font-size-10"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                        </div>
                                        <div class="col-4">
