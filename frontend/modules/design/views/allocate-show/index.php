                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <div type="submit" class="btn btn-primary  pt-3 pb-3 font-size-12" style="border-radius: 3px;"><i class="fa fa-th-large text-white" aria-hidden="true"></i>&nbsp; KFI Dashboard</div>
                        </div>
                    </div>
                    <div class="row pt-30">
                        <div class="col-4">
                        ...
                        <div class="col-3 pt-5">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="procresscircle_deg">100%</div> <img src="<?= Yii::$app->homeUrl ?>images/icons/Dark/48px/Wornning-blue.png" class="wb-progress">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-1">
                        ...
                        ?>
                            ...
                            <div class="col-12 pl-15" style="margin-top:<?= $i == 4 ? '35px;' : '35px;' ?>">
                            ...
                            <table class="table table-borderless table-striped">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-12 border-right pr-15">
                                                <span class="set-page">Profit</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="col-12 border-right pr-12">
                                                ...
                                                <div class="col-12 nm_berformat text-secondary">
                                        ...
                                        <td>
                                            <div class="pr-10">
                                                ...
                                                <div class="input-group" style="margin-top: -16px;margin-left:5px;">
                                                    ...
                                                    <input type="text" class="form-control Level-txtinput" placeholder="385,235" aria-label="Sizing example input">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
