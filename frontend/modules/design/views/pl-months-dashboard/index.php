<?php
$this->title = 'Default 12 Months Dashboard';
?>
                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-lg-1 col-md-1 col-sm-1 col-1 card months_lights mt-15">
                                ...
                                <div class="col-12 AAR-2022-1 pt-5">
                        ...
                        <div class="row">
                            <div class="col-lg-1 col-md-1 col-sm-1 col-1 card months_lights">
                                <div class="col-12 months12_number">
                                    <?= number_format(1000) ?>
                                </div>
                                <div class="col-12 months12_number_notsolid">
                                    <?= number_format(1000) ?>
                                </div>
                            </div>
                            <div class="col-lg-1 col-md-1 col-sm-1 col-1 card months_lights">
