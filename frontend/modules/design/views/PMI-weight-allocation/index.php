                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-1 col-md-6 col-12">
                            <div class="Evalua_tor1 pb-30">
                                <div class="col-12 text_PIM">
                                    PIM
                                </div>
                                <div class="col-12">
                                    <div id="progress1">
                                        <div data-num="85" class="progress-item1" data-value="85%" style="background: conic-gradient(rgb(41, 140, 233) calc(35%), rgb(219, 239, 247) 0deg);width: 50px;height:50px;">85%</div>
                                    </div>
                                </div>
                                <div class="white-kfi3">
                                    <div class="col-12 pt-30">
                                        <div class="form-check pl-40">
                        ...
                        <div class="col-lg-9 col-md-6 col-12">
                            <div class="Evalua_tor2 silly_scrollbar">
                                        ...
                                        ?>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="card font-size-12">
                                                    <div class="card-header fonTotal">Totalsale</div>
                                ...
                                <div class="silly_evaluator mt-20">
                                    <div class="row pl-15 pr-15 pt-10 pb-15">
                                        <div class="col-6 flagkey">
                                    ...
                                    <div class="row pl-15 pr-10 pb-20">
                                        ...
                                        ?>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="card font-size-12">
                                                    <div class="card-header fonTotal">Totalsales</div>
