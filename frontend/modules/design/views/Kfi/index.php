                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header" style="border-bottom:none;">
                                                            <div class="modal-title Modalfirstone" id="exampleModalfirstoneLabel"><i class="fa fa-line-chart" aria-hidden="true"></i> Total Sales</div>
                                                                ...
                                                                <div class="tab-pane fade show active" id="pills-Issues" role="tabpanel" aria-labelledby="pills-Issues-tab">
                                                                    <ul>
                                                                        ...
                                                                        <div class="col-12 text-end mt-20">
                                                                            <span type="button" class="canceltomato" data-bs-dismiss="modal">Cancel</span>
                                                                        </div>
                                                                    </ul>
                                                                </div>
