                                ...
                                <tbody>
                                    <tr class="border-bottom-white2">
                                        ...
                                        <td colspan="row">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <li>
                                                    <a class="dropdown-item" href="#"><i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="#"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></a>
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-pills mb-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12">
                            <a class="link-pills" id="v-pills-Issues-tab" data-bs-toggle="pill" data-bs-target="#v-pills-Issues" type="button" role="tab" aria-controls="v-pills-Issues" aria-selected="true">Issues</a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            <a class="link-pills" id="v-pills-History-tab" data-bs-toggle="pill" data-bs-target="#v-pills-History" type="button" role="tab" aria-controls="v-pills-History" aria-selected="false">History</a>
                        </div>
                    </div>
                </ul>
                <hr>
