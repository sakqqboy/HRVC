                    ...
                    <div class="badge bg-primary-sec4">
                        <div class="row">
                            ...
                            <div class="col-1" style="margin-left:55px;">
                                <a href="" class="no-underline-black link-Ideal" data-bs-target="modal" aria-label="#modal"> Next Year Target</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-9 col-md-6 col-12 ">
                            <div class="card alert-alpri6">
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <div role="progressbar4" aria-valuenow="100" aria-valuemin="100" aria-valuemax="0" style="--value:100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
