							...
							<div class="col-lg-5 col-11">
								<div class="col-11">
									...
									<div class="row pr-0 pl-0 mt-5">
										...
										<div class="col-4 font-size-10 mt-8 text-center" style="letter-spacing: 1px;">
											ANNUAL SUMMARY</div>
										<div class="col-4 line mt-15"></div>
									</div>
								</div>
								<div class="row">
									<div class="col-11">
										<div class="row mt-15 pb-5" style="background-color: #dee2e6;border-radius:2px;">
											...
											<div class="col-2">
												<div class="row pl-10">
													<div class="col-5 badge dge_AAR_blue font-size-8 mt-5 pt-5 pl-3">AAR
													</div>
											...
											<div class="col-2">
												<div class="row pl-10">
													<div class="col-5 badge dge_AAR_green font-size-8 mt-5 pt-5 pl-3">
														AAR</div>
											...
											<div class="col-3 pl-10">
												<div class="row">
													<div class="col-4 badge dge_AAR_warning font-size-8 mt-5 pt-5">AT
													</div>
													<div class="col-4 AA-2022 pt-5 pl-7">2023</div>
													<div class="col-4 badge dge_AAR_warning font-size-8 mt-5 pt-5">ATR
													</div>
												</div>
											</div>
											<div class="col-2">
												<div class="row pl-12">
													<div class="col-5 badge dge_AAR_light_blue font-size-8 mt-5 pt-5 pl-3 pr-3">
														ATR</div>
							...
							<div class="col-lg-7">
								<div class="row" style="background-color: #dee2e6;border-radius:2px;">
									...
									<div class="col-2 pt-3 pb-3">
										<select class="form-select text-primary" aria-label="Default select example" style="height: 25px;font-size: 10px;">
									...
									<div class="col-2 bg-light pt-3 pb-5 mt-5" data-bs-toggle="modal" data-bs-target="#staticBackdropCurrency" style="height: 22px;font-size: 10px;border-radius:3px;cursor:pointer;">
										<i class="fa fa-usd pl-1 font-size-10" aria-hidden="true"></i>
										<span class="Currency_fs"> Currency</span>
									</div>
								...
								<div class="row pr-0 pl-0 mt-5">
									...
									<div class="col-2 font-size-10 mt-8 text-center" style="letter-spacing: 1px;">
										QUARTERLY
									</div>
									<div class="col-5 line mt-15"></div>
								</div>
								<div class="row mt-15">
									...
									<div class="col-lg-4 col-sm-6 col-12 pl-5 pr-5">
										...
										<div class="col-12 pr-12 pl-12 mt-5">
											...
											for ($i = 1; $i <= 15; $i++) {
											?>
												<div class="row mb-7 pt-4 pb-4 border-buttom-bold mt-5" style="background-color: rgb(246 246 246);font-size: 10px;">
													<div class="col-3 border-buttom mb-2 pb-2">
														<?= number_format(1000) ?>
													</div>
													<div class="col-3 border-buttom mb-2 pb-2">
