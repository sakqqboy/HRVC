...
<title>Admin Finalcial Planing Current Month</title>
					...
					<div class="row mt-10 pr-0">
						...
						<div class="col-lg-7">
							...
							<div class="row pr-0 pl-0 mt-5">
								...
								<div class="col-2 font-size-10 mt-8 text-center" style="letter-spacing: 1px;">MIXED</div>
								<div class="col-5 line mt-15"></div>
							</div>
							<div class="row mt-15">
								<?php
								...
								?>
										<div class="col-<?= $month == $nextMonth ? '3' : '4' ?> pl-5 pr-5">
											<div class="col-12 pr-10 pl-12">
												<div class="row" style="background-color: #dee2e6;border-radius:2px;">
													...
													<div class="col-lg-<?= $month == $nextMonth ? '4' : '3' ?> pl-15">
														<div class="row">
											...
											<div class="col-12 pr-12 pl-12 mt-5">
												...
												for ($i = 1; $i <= 15; $i++) {
												?>
													<div class="row mb-7 pt-4 pb-4 border-buttom-bold months12_number text-center" style="background-color: rgb(246 246 246);">
														<div class="col-<?= $month == $nextMonth ? '4' : '3' ?> border-buttom mb-2 pb-2 text-black-50 ">
															<?= number_format(1000) ?>
														</div>
														<div class="col-<?= $month == $nextMonth ? '4' : '3' ?> border-buttom mb-2 pb-2">
															<?= number_format(2000) ?>
														</div>
														<div class="col-<?= $month == $nextMonth ? '4' : '3' ?> border-buttom mb-2 pb-2">
															<?= number_format(1800) ?>
														...
														if ($month != $nextMonth) {
														?>
															<div class="col-3 border-buttom mb-2 pb-2 text-black-50">
																<?= number_format(2500) ?>
															</div>
														<?php
														}
														?>
														<div class="col-<?= $month == $nextMonth ? '4' : '3' ?> text-secondary">
															<?= number_format(1000) ?>
														</div>
														<div class="col-<?= $month == $nextMonth ? '4' : '3' ?>">
															<?= number_format(2000) ?>
														</div>
														<div class="col-<?= $month == $nextMonth ? '4' : '3' ?>">
															<?= number_format(1800) ?>
										...
										<div class="col-lg-1 pl-5 pr-0">
											<div class="col-12 pr-10 pl-12">
												<div class="row" style="background-color: #dee2e6;border-radius:2px;">
													...
													<div class="col-lg-12 pl-15 pr-0">
														<div class="row">
															<div class="col-4 badge dge_AAR_green pt-3" style="height: 13px;">AC</div>
															<div class="col-8 AA-2022 pl-3">2023</div>
														</div>
													</div>
												</div>
											</div>
											<div class="col-12 pr-12 pl-12 mt-5">
												...
												?>
													<div class="row mb-7 pt-4 pb-4 border-buttom-bold months12_number text-center" style="background-color: rgb(246 246 246);">
														<div class="col-12 border-buttom mb-2 pb-2">
															<?= number_format(1800) ?>
														</div>
														<div class="col-12">
															<?= number_format(2000) ?>
