							...
							<div class="col-4">
								<div class="row" style="background-color: #dee2e6;">
									...
									<div class="col-4 pt-3 pb-3">
										<select class="form-select text-primary" style="height: 25px;font-size:10px;" id="current_year" name="current_year" onchange="getData()">
...
<script>
	...
	function getData() {
		...
		$.ajax({
			...
			url: 'ajax/branch_pl_data_edit/get_data_test.php',
			type: 'POST',
			dataType: 'html',
			data: {
