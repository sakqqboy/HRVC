		...
		<div class="col-12 mt-10">
			<div class="shadow pb-5 pt-5 mb-5 bg-body rounded alert2-secondary3">
				<ul class="nav nav-pills" id="pills-tab" role="tablist">
					...
					<li class="nav-item" role="presentation">
						<a href="golden_ratio.php?branch=<?php echo (int)$_GET['branch']; ?>" class="nav-link active"><img src="../images/icons/Light/Light/48px/Golden-Ratio.png" class="images_performance_PL"> Golden Ratio</a>
					</li>
					<li class="nav-item" role="presentation">
