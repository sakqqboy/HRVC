...
<div class="modal-header">
    <h6 class="modal-title text-primary">Edit Branch</h6>
        ...
        <div class="col-12">
            <div class="row">
                        ...
                        <div class="BroweForFile">
                            ...
                            <div id="show_branch_logo">
                                <label for="branch_logo">
                                    <a><img id="logo" src="../images/company/logo/<?php echo $row['branch_logo']; ?>" width="90px" height="90px" /></a>
                                </label>
                            </div><br />
                ...
                <div class="col-lg-6 pt-4">
                    ...
                    <input type="text" name="branchName" id="branchName" class="form-control pb-5 pt-5 font-size-13" value="<?php echo $row['branchName']; ?>">
                </div>
                <div class="col-lg-6">
                    ...
                    <select class="form-select pb-5 pt-5 font-size-13" name="financial_start_month" id="financial_start_month">
                        ...
                        foreach ($months as $index => $month) { ?>
                            <option value="<?php echo $index; ?>" <?php echo ($row['financial_start_month'] == $index)?"selected":""; ?>><?php echo $month; ?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="col-lg-6 pt-4">
                ...
                <div class="col-lg-12 pt-4">
                    ...
                    <input type="text" name="note" id="note" class="form-control pb-5 pt-5 font-size-13" placeholder="description" value="<?php echo $row['description']; ?>">
                </div>
            </div>
        </div>
    </form>
