...
$filterYear = mysqli_real_escape_string($connection, $_POST['start_year']);
$filterMonth = mysqli_real_escape_string($connection, $_POST['start_month']);
...
$defaultMonth = $row_select['financial_start_month'];
...
} else if ($filterMonth < $defaultMonth) {
    $startYear = $filterYear - 1;
...
$monthsApart = ($endYear - $startYear) * 12 + ($endMonth - $startMonth);

$max_loop = $monthsApart + 1;
...
for ($i = 0; $i < $max_loop; $i++) {
    ...
    if ($i == ($max_loop - 1)) {
        $end_date = "$monthName $currentYear";
    }
...
<div class="row">
    <div class="col-9">
        <div class="col-12 pt-2">
            <h6><?php echo $first_date . " - " . $end_date; ?></h6>
        </div>
        <div class="col-12">
