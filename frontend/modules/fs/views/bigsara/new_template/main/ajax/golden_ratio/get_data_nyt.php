...
<div class="row">
    <div class="alert alert-sea popup d-flex align-items-center justify-content-evenly" style="top: 20%;left: 25%;width: 20%;height: 4%;">
        ...
        <span class="badge text-dark" style="background-color: rgb(127,225,225);">
            <?php
            $Variable_Expense_Ratio = calculateDivide(round($listHead[1]['data'][0]['percent_accum_next_tar'], 2), round($listHead[0]['data'][0]['percent_accum_next_tar'], 2)) * 100;
    ...
    <div class="alert alert-yellow popup d-flex align-items-center justify-content-evenly" style="top: 38%;left: 27%;width: 40%;height: 4%;">
        ...
        <span class="badge text-dark" style="background-color: rgb(255,235,135);">
            <?php
            $Labor_Cost_Ratio = calculateDivide(round($listHead[1]['data'][0]['percent_accum_next_tar'], 2), round($listHead[0]['data'][0]['percent_accum_next_tar'], 2)) * 100;
    ...
    <div class="alert alert-blue popup d-flex align-items-center justify-content-evenly" style="top: 45%;left: 23%;width: 20%;height: 4%;">
        ...
        <span class="badge bg-light text-dark">
            <?php
            $Gross_Profit_Ratio = calculateDivide(round($listHead[2]['data'][0]['percent_accum_next_tar'], 2), round($listHead[0]['data'][0]['percent_accum_next_tar'], 2)) * 100;
    ...
    <div class="alert alert-yellow popup d-flex align-items-center justify-content-evenly" style="top: 45%;left: 50%;width: 20%;height: 4%;">
        ...
        <span class="badge text-dark" style="background-color: rgb(255,235,135);">
            <?php
            $Labor_Ratio = calculateDivide(round($listHead[1]['data'][0]['percent_accum_next_tar'], 2), round($listHead[0]['data'][0]['percent_accum_next_tar'], 2)) * 100;
    ...
    <div class="alert alert-violet popup d-flex align-items-center justify-content-evenly" style="top: 57%;left: 50%;width: 20%;height: 4%;">
        ...
        <span class="badge text-dark" style="background-color: rgb(220,180,255);">
            <?php
            $Fixed_Expense_Ratio = calculateDivide(round($listHead[1]['data'][0]['percent_accum_next_tar'], 2), round($listHead[0]['data'][0]['percent_accum_next_tar'], 2)) * 100;
    ...
    <div class="alert alert-lime popup d-flex align-items-center justify-content-evenly" style="top: 75%;left: 27%;width: 40%;height: 4%;">
        ...
        <span class="badge bg-light text-dark">
            <?php
            $Ordinary_Profit_to_Net_Sales_Ratio = calculateDivide(round($listHead[5]['data'][0]['percent_accum_next_tar'], 2), round($listHead[0]['data'][0]['percent_accum_next_tar'], 2)) * 100;
        ...
        <div class="card card-blue h-100">
            ...
            <div class="card-body d-flex align-items-center justify-content-center">
                <div class="text-center">
                    ...
                    <h5 class="card-title"><?php echo number_format($listHead[0]['data'][0]['accum_next_tar']); ?></h5>
                    <h4 class="card-title"><?php echo round($listHead[0]['data'][0]['percent_accum_next_tar'], 2); ?>%</h4>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card card-green ">
                    ...
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <div class="text-center">
                            ...
                            <h5 class="card-title"><?php echo number_format($listHead[1]['data'][0]['accum_next_tar']); ?></h5>
                            <h4 class="card-title"><?php echo round($listHead[1]['data'][0]['percent_accum_next_tar'], 2); ?>%</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-5">
                <div class="card card-violet h-100">
                    ...
                    <div class="text-center" style="position: absolute;top: 50%;left: 15%;">
                        ...
                        <h5 class="card-title"><?php echo number_format($listHead[2]['data'][0]['accum_next_tar']); ?></h5>
                        <h4 class="card-title"><?php echo round($listHead[2]['data'][0]['percent_accum_next_tar'], 2); ?>%</h4>
                    </div>
                    <!-- </div> -->
                </div>
            </div>
                        ...
                        <div class="card card-gray h-100">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-center">
                                <div class="text-center">
                                    ...
                                    <h5 class="card-title"><?php echo number_format($listHead[3]['data'][0]['accum_next_tar']); ?></h5>
                                    <h4 class="card-title"><?php echo round($listHead[3]['data'][0]['percent_accum_next_tar'], 2); ?>%</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-taro h-100">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-center">
                                <div class="text-center">
                                    ...
                                    <h5 class="card-title"><?php echo number_format($listHead[4]['data'][0]['accum_next_tar']); ?></h5>
                                    <h4 class="card-title"><?php echo round($listHead[4]['data'][0]['percent_accum_next_tar'], 2); ?>%</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-lime h-100">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-center">
                                <div class="text-center">
                                    ...
                                    <h5 class="card-title"><?php echo number_format($listHead[5]['data'][0]['accum_next_tar']); ?></h5>
                                    <h4 class="card-title"><?php echo round($listHead[5]['data'][0]['percent_accum_next_tar'], 2); ?>%</h4>
                                </div>
                            </div>
                        </div>
                    </div>
