...
<form id="form_ImportPLFlow">
    <div class="modal-header">
        <h6 class="modal-title text-primary"><i class="fa fa-magic" aria-hidden="true"></i> IMPORT PL Flow</h6>
    ...
    <div class="modal-body">
        <div class="col-12 text-center mt-10 pt-20 pb-20">
            ...
            <div id="drop_zone" class="offset-3 col-6 drop-zone mt-20">
                ...
                <input type="file" id="file_input" name="excelFile" style="display:none;z-index:99" onchange="getFileName()">
            ...
            <div class="row mt-20" id="show_file" style="display:none;">
                <div class="offset-4 col-4 download-progress">
                    <div class="row">
                        <div class="col-4 text-end mb-10">
                            <img src="../images/excel.png" style="height: 45px;" class="mr-10">
                        </div>
                        <div class="col-8 text-start mb-10">
                            <span class="font-size-14 font-b" id="file_name"></span>
                        </div>
                    </div>
                    <!-- <div class="progress">
    ...
    <div class="modal-footer d-flex justify-content-center" style="border:none;">
        ...
        <button type="button" class="btn btn-primary pt-4 pb-4 font-size-14" onclick="importPLFlow()">DONE</button>
    </div>
</form>
