				...
				<div class="alert alert2-secondary3 pr-5">
					...
					<div class="row mt-5">
						...
						<div class="col-lg-3 pl-0">
							<a class="btn btn-primary Register_financial text-center pt-3 pb-5" onclick="register()">
						...
						<div class="row mt-4">
							<div class="col-8">
								<div class="row" style="background-color: #dee2e6;">
									...
									<div class="col pt-3 pb-3" id="show_year"></div>
									...
									<div class="col-4 pt-3 pb-3" id="show_breakdown"></div>
...
<script>
	...
	function register() {
		...
		let breakdown_id = $("#breakdown_id").val();
		if (breakdown_id != '') {
			window.location.href = 'fs_edit.php?branch=' + branchId + '&&breakdown=' + breakdown_id + '&&start_year=' + start_year;
		}
