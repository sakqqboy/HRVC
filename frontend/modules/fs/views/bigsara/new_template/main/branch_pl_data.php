				...
				<div class="alert alert2-secondary3 pr-5">
					<div class="row">
						...
						<div class="col-lg-3 pl-0">
							<a href="branch_pl_data_edit.php?branch=<?php echo $_GET['branch']; ?>&&breakdown=<?php echo $_GET['breakdown']; ?>" class="btn btn-primary Register_financial text-center pt-3 pb-5">
...
<script>
	...
	function getData() {
		...
		$.ajax({
			...
			url: 'ajax/branch_pl_data/get_data.php',
			type: 'POST',
			dataType: 'html',
			data: {
