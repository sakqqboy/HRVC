						...
						<div class="row">
							...
							<div class="col-lg-10 col-12 text-end ">
								...
								<div class="btn-group ml-15 " role="group">
									<a href="annual_graph.php?branch=<?php echo (int)$_GET['branch']; ?>" type="button" class="btn btn-outline-primary font-size-12" style="border-color:blue;">
										<i class="fa fa-bar-chart" aria-hidden="true"></i>
									</a>
									<a type="button" class="btn btn-outline-secondary font-size-12" style="border-left: 0;border-color:lightgray;">
										Performance Chart
									</a>
									<a href="chart_ipl_analysis.php?branch=<?php echo (int)$_GET['branch']; ?>" type="button" class="btn btn-outline-secondary font-size-12" style="border-color:lightgray;">IPL Analysis</a>
									<a href="chart_annual_compare.php?branch=<?php echo (int)$_GET['branch']; ?>" type="button" class="btn btn-outline-secondary font-size-12" style="border-color:lightgray;">PLF Overview</a>
								</div>
							</div>
						</div>
