...
<div class="sidebar">
    ...
    <div class="col-12" style="margin-top: 20px;">
        ...
        <div id="group-management" style="display: none;">
            ...
            <div class="col-12 first-layer-manu">
                <a href="<?= $url ?>fs/default/fs-menu?id= &&menu=branch" class="no-underline" style="text-decoration: none;">
...
<script>
    ...
    function linkMenu(id, menu, url) {
        // var url = `${$baseUrl}fs/default/menu-company-id?companyId=${companyId}`;
        window.location.replace(url + 'fs/default/fs-menu?id=' + id + '&&menu=' + menu);
        // fetch(url, {
        //         method: "GET"
        //     }) // ✅ ใช้ GET Request
        //     .then(response => {
