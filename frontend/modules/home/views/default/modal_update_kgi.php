    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-6 pt-10">
                                ...
                                <select class="form-select font-size-13" aria-label="Default select example"
                                    ...
                                    <option value=""><?= Yii::t('app', 'Quantity / Quality') ?></option>
                            ...
                            <div class="col-lg-6 col-md-6 col-6 pt-10">
                                <label for="exampleFormControl" class="form-label font-size-13"><strong
                                        class="red">*</strong> <?= Yii::t('app', 'Priority') ?></label>
                                <select class="form-select font-size-13" aria-label="Default select example"
                                    id="priority-update" name="priority">
                                    <option value=""><?= Yii::t('app', 'A/B/C') ?></option>
                                    <option value="A"><?= Yii::t('app', 'A') ?></option>
                                    <option value="B"><?= Yii::t('app', 'B') ?></option>
                                    <option value="C"><?= Yii::t('app', 'C') ?></option>
                                </select>
                            </div>
                            <div class="col-lg-4 col-md-6 col-6 pt-10">
                                ...
                                <select class="form-select font-size-13" aria-label="Default select example"
                                    ...
                                    <option value=""><?= Yii::t('app', '% or Number') ?></option>
                                    <option value="1"><?= Yii::t('app', '%') ?></option>
                            ...
                            <div class="col-12 mt-10">
                                <label for="exampleFormControl" class="form-label font-size-13"><strong
                                        class="red">*</strong> <?= Yii::t('app', 'Result') ?></label>
            ...
            <div class="modal-footer" style="border: none;">
                ...
                <a href="javascript:checkRequiredUpdate()" class="btn btn-warning"><?= Yii::t('app', 'Update') ?></a>
            </div>
        </div>
    </div>
