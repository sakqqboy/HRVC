...
<div class="row" style="--bs-gutter-x:0px;">
    ...
    ?>
        <!-- Card 1 -->
        <div class="col-lg-4 col-md-6 col-12 mb-3 pr-16">
                        ...
                        <div class="col-7 text-start">
                            <span class="key-title">
                                <img src="<?= Yii::$app->homeUrl ?>images/icons/black-icons/FinancialSystem/KFI.svg"
                                    style="width: 24px; height: 24px;" class="mr-10">
                                <span class="card-title-text"><?= Yii::t('app', 'Key Financial Indicator') ?></span>
                            </span>
                        </div>
                        <!-- Right Section -->
    ...
    ?>
    <!-- Card 2 -->
    <div class="col-lg-4 col-md-6 col-12 mb-3 <?= $tab == 'company' ? 'pr-8 pl-8' : 'pr-12' ?>">
                    ...
                    <div class="col-7 text-start">
                        <span class="key-title">
                            <img src="<?= Yii::$app->homeUrl ?>images/icons/black-icons/FinancialSystem/KGI.svg"
                                style="width: 24px; height: 24px;" class="mr-10">
                            <span class="card-title-text"><?= Yii::t('app', 'Key Goal Indicator') ?></span>
                        </span>
                    </div>
                    <!-- Right Section -->
                    <div class="col-5 text-end">
    ...
    <!-- Card 3 -->
    <div class="col-lg-4 col-md-6 col-12 mb-3 <?= $tab == 'company' ? 'pl-16' : 'pl-12' ?>">
                    ...
                    <div class="col-8 text-start">
                        <span class="key-title">
                            <img src="<?= Yii::$app->homeUrl ?>images/icons/black-icons/FinancialSystem/KPI.svg"
                                style="width: 24px; height: 24px;" class="mr-10">
                            <span class="card-title-text"><?= Yii::t('app', 'Key Performance Indicator') ?></span>
                        </span>
                    </div>
                    <!-- Right Section -->
                    <div class="col-4 text-end">
