...
use Yii;
use \frontend\models\hrvc\master\EmployeeSalaryHistoryMaster;
...
class EmployeeSalaryHistory extends \frontend\models\hrvc\master\EmployeeSalaryHistoryMaster{
    /**
    * @inheritdoc
    */
