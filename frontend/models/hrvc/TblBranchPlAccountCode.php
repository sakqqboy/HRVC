...
use Yii;
use \frontend\models\hrvc\master\TblBranchPlAccountCodeMaster;
...
class TblBranchPlAccountCode extends \frontend\models\hrvc\master\TblBranchPlAccountCodeMaster{
    /**
    * @inheritdoc
    */
