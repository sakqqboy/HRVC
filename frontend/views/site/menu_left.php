...
<div class="col-12" style="min-height:calc(100vh - 60px);">
    <div class="col-12">
        <a href="<?= Yii::$app->homeUrl ?>site/index">
            <div class="col-12">
                <img src="<?= Yii::$app->homeUrl ?>image/HRVC_Logos-New.svg">
    ...
    <div class="col-12 mt-17 d-none">
        <div class="btn-group-menu" onclick="javascript:toggleGroupMenuI('financial-system')">
            <div class="row">
                <div class="col-2 pl-20">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/FinancialSystem/fs.svg"
                        class="home-icon" style="margin-top: -3px;">
                </div>
                <div class="col-8 text-start pr-0 pl-5"><?= Yii::t('app', 'Financial System') ?></div>
                <div class="col-2 pr-0 pl-5 text-start">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/4.svg" class="home-icon"
                        style="margin-top: -3px;cursor: pointer;display:<?= $session->has('financial-system') ? '' : 'none' ?>;"
                        id="financial-system-hide">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/7.svg" class="home-icon"
                        style="margin-top: -3px;cursor: pointer;display:<?= $session->has('financial-system') ? 'none' : '' ?>;"
                        id="financial-system-show">
                </div>
            </div>
        </div>
        <div id="financial-system" style="display:<?= $session->has('financial-system') ? '' : 'none' ?>;">
            ...
            <div class="col-12 first-layer-manu">
                <a href="<?= Path::fsModule() ?>?__id=<?= Yii::$app->user->id ?>" class="no-underline">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/FinancialSystem/dashboard.svg"
                        class="first-layer-icon" style="margin-top: -3px;">
                    <?= Yii::t('app', 'Dashboard') ?>
                </a>
            </div>
            <div class="col-12 first-layer-manu">
                <a href="<?= Path::fsModule() ?>?__id=<?= Yii::$app->user->id ?>" class="no-underline">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/FinancialSystem/pl_forecase.svg"
                        class="first-layer-icon" style="margin-top: -3px;">
            ...
            <div class="col-12 first-layer-manu">
                <a href="<?= Path::fsModule() ?>?__id=<?= Yii::$app->user->id ?>" class="no-underline">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/FinancialSystem/pl_config.svg"
                        class="first-layer-icon" style="margin-top: -3px;">
            ...
            <div class="col-12 first-layer-manu">
                <a href="<?= Path::fsModule() ?>?__id=<?= Yii::$app->user->id ?>" class="no-underline">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/FinancialSystem/golden.svg"
                        class="first-layer-icon" style="margin-top: -3px;">
            ...
            <div class="col-12 first-layer-manu">
                <a href="<?= Path::fsModule() ?>?__id=<?= Yii::$app->user->id ?>" class="no-underline">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/FinancialSystem/forecast_account.svg"
                        class="first-layer-icon" style="margin-top: -3px;">
            ...
            <div class="col-12 first-layer-manu">
                <a href="<?= Path::fsModule() ?>?__id=<?= Yii::$app->user->id ?>" class="no-underline">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/FinancialSystem/currency.svg"
                        class="first-layer-icon" style="margin-top: -3px;">
    ...
    <div class="col-12 mt-17">
        <div class="btn-group-menu" onclick="javascript:toggleGroupMenuI('performance-matrices')">
            <div class="row">
                <div class="col-2 pl-20">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/performance.svg"
                        class="home-icon2" style="margin-top: -3px;">
                </div>
                <div class="col-8 text-start pr-0 pl-5"><?= Yii::t('app', 'Performance Matrices') ?></div>
                <div class="col-2 pr-0 pl-5 text-start">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/4.svg" class="home-icon"
                        style="margin-top: -3px;cursor: pointer;display:<?= $session->has('performance-matrices') ? '' : 'none' ?>"
                        id="performance-matrices-hide">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/7.svg" class="home-icon"
                        style="margin-top: -3px;cursor: pointer;display:<?= $session->has('performance-matrices') ? 'none' : '' ?>"
                        id="performance-matrices-show">
                </div>
            </div>
        </div>
        <div id="performance-matrices" style="display:<?= $session->has('performance-matrices') ? '' : 'none' ?>;">
            ...
            <div class="col-12 first-layer-manu">
                <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/KFI.svg"
                    class="first-layer-icon" style="margin-top: -3px;">
                <a href="<?= Yii::$app->homeUrl ?>kfi/management/grid" class="no-underline">
                    <?= Yii::t('app', "Financials") ?>
                </a>
                <span style="float: right;">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6.svg" class="first-layer-icon"
                        style="cursor:pointer;margin-top: -3px;display:<?= $session->has('third-layer-kfi') ? '' : 'none' ?>;"
                        onclick="javascript:hideGroupMenu('third-layer-kfi')" id="third-layer-kfi-hide">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6-1.svg" class="first-layer-icon"
                        style="cursor:pointer;margin-top: -3px;display:<?= $session->has('third-layer-kfi') ? 'none' : '' ?>"
                        onclick="javascript:showGroupMenu('third-layer-kfi')" id="third-layer-kfi-show">
                </span>
                <div class="col-12" id="third-layer-kfi"
                    style="display:<?= $session->has('third-layer-kfi') ? '' : 'none' ?>;">
                    <div class="col-12 second-layer-menu">
                        <a href="<?= Yii::$app->homeUrl ?>kfi/management/grid" class="no-underline">
                            <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/company.svg"
                                class="first-layer-icon" style="margin-top: -3px;">
            ...
            <div class="col-12 first-layer-manu">
                <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/KGI.svg"
                    class="first-layer-icon" style="margin-top: -3px;">
                ...
                <span style="float: right;">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6.svg" class="first-layer-icon"
                        style="cursor:pointer;margin-top: -3px;display:<?= $session->has('third-layer-kgi') ? '' : 'none' ?>;"
                ...
                <div class="col-12" id="third-layer-kgi"
                    style="display:<?= $session->has('third-layer-kgi') ? '' : 'none' ?>;">
                    <div class="col-12 second-layer-menu">
                        <a href="<?= Yii::$app->homeUrl ?>kgi/management/grid" class="no-underline">
                            <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/company.svg"
                                class="first-layer-icon" style="margin-top: -3px;">
                    ...
                    <div class="col-12 second-layer-menu">
                        <a href="<?= Yii::$app->homeUrl ?>kgi/kgi-team/team-kgi-grid" class="no-underline">
                            <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/team.svg"
                                class="first-layer-icon" style="margin-top: -3px;">
                            <?= Yii::t('app', 'Team KGI') ?>
                        </a>
                    </div>
                    <div class="col-12 second-layer-menu">
                        <a href="<?= Yii::$app->homeUrl ?>kgi/kgi-personal/individual-kgi-grid" class="no-underline">
                            <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/self.svg"
                                class="first-layer-icon" style="margin-top: -3px;">
                            <?= Yii::t('app', 'Self KGI') ?>
                        </a>
                    </div>
            ...
            <div class="col-12 first-layer-manu">
                <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/KPI.svg"
                    class="first-layer-icon" style="margin-top: -3px;">
                ...
                <span style="float: right;">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6.svg" class="first-layer-icon"
                        style="cursor:pointer;margin-top: -3px;display:<?= $session->has('third-layer-kpi') ? '' : 'none' ?>;"
                ...
                <div class="col-12" id="third-layer-kpi"
                    style="display:<?= $session->has('third-layer-kpi') ? '' : 'none' ?>;">
                    <div class="col-12 second-layer-menu">
                        <a href="<?= Yii::$app->homeUrl ?>kpi/management/grid" class="no-underline">
                            <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/PerformanceMatrices/company.svg"
                                class="first-layer-icon" style="margin-top: -3px;">
    ...
    <div class="col-12 mt-17">
        <div class="btn-group-menu" onclick="javascript:toggleGroupMenuI('evaluation-system')">
            <div class="row">
                ...
                <div class="col-2 pr-0 pl-5 text-start">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/4.svg" class="home-icon"
                        style="margin-top: -3px;cursor: pointer;display:<?= $session->has('evaluation-system') ? '' : 'none' ?>;"
                        id="evaluation-system-hide">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/7.svg" class="home-icon"
                        style="margin-top: -3px;cursor: pointer;display:<?= $session->has('evaluation-system') ? 'none' : '' ?>;"
                        id="evaluation-system-show">
                </div>
            </div>
        </div>
        <div id="evaluation-system" style="display:<?= $session->has('evaluation-system') ? '' : 'none' ?>;">
            <div class="col-12 first-layer-manu">
                ...
                <span style="float: right;">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6.svg" class="first-layer-icon"
                        style="cursor:pointer;margin-top: -3px;display:<?= $session->has('evaluation-environment') ? '' : 'none' ?>;"
            ...
            <div id="evaluation-environment"
                ...
                <div class="col-12 second-layer-menu">
                    ...
                    <span style="float: right;">
                        <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6.svg"
                            class="first-layer-icon"
                            style="cursor:pointer;margin-top: -3px;display:<?= $session->has('third-layer-performane') ? '' : 'none' ?>;"
                            onclick="javascript:hideGroupMenu('third-layer-performane')"
                            id="third-layer-performane-hide">
                        <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6-1.svg"
                            class="first-layer-icon"
                            style="cursor:pointer;margin-top: -3px;display:<?= $session->has('third-layer-performane') ? 'none' : '' ?>"
    ...
    <div class="col-12 mt-17 d-none">
        <div class="btn-group-menu" onclick="javascript:toggleGroupMenuI('behavioral-evaluation')">
            <div class="row">
                <div class="col-2 pl-20">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/BehavioralEvaluation/evaluation.svg"
                        class="home-icon" style="margin-top: -3px;">
                </div>
                <div class="col-8 text-start pr-0 pl-5"><?= Yii::t('app', 'Behavioral Evaluation') ?></div>
                <div class="col-2 pr-0 pl-5 text-start">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/4.svg" class="home-icon"
                        style="margin-top: -3px;cursor: pointer;display:<?= $session->has('behavioral-evaluation') ? '' : 'none' ?>;"
                        id="behavioral-evaluation-hide">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/7.svg" class="home-icon"
                        style="margin-top: -3px;cursor: pointer;display:<?= $session->has('behavioral-evaluation') ? 'none' : '' ?>"
                        id="behavioral-evaluation-show">
                </div>
            </div>
        </div>
        <div id="behavioral-evaluation" style="display:<?= $session->has('behavioral-evaluation') ? '' : 'none' ?>;">
            <div class="col-12 first-layer-manu">
                ...
                <span style="float: right;">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6.svg" class="first-layer-icon"
                        style="cursor:pointer;margin-top: -3px;display:none;display:<?= $session->has('behavioral-indicator') ? '' : 'none' ?>;"
                        onclick="javascript:hideGroupMenu('behavioral-indicator')" id="behavioral-indicator-hide">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6-1.svg" class="first-layer-icon"
                        style="cursor:pointer;margin-top: -3px;display:<?= $session->has('behavioral-indicator') ? 'none' : '' ?>;"
                        onclick="javascript:showGroupMenu('behavioral-indicator')" id="behavioral-indicator-show">
                </span>
            </div>
            ...
            <div class="col-12 first-layer-manu">
                <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/BehavioralEvaluation/360.svg"
                    class="first-layer-icon" style="margin-top: -3px;">
                <?= Yii::t('app', '360 Degree Evaluation') ?>
            </div>
            <div class="col-12 first-layer-manu">
                <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/BehavioralEvaluation/company_dashboard.svg"
                    class="first-layer-icon" style="margin-top: -3px;">
                <?= Yii::t('app', 'Company Dashboard') ?>
                <span style="float: right;">
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/6.svg" class="first-layer-icon"
                        style="cursor:pointer;margin-top: -3px;display:<?= $session->has('company-dashboard') ? '' : 'none' ?>;"
    ...
    <div class="d-flex" style="width:100%;bottom:0;position:absolute;">
        <div class="btn-hrvc-home">
            <a href="<?= Yii::$app->homeUrl ?>language/default/index" class="text-light" style="text-decoration: none;">
                <span>
                    <img src="<?= Yii::$app->homeUrl ?>images/icons/white-icons/others/8.svg" class="home-icon"
                        style="margin-top: -3px;">
