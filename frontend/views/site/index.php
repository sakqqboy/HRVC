    ...
    <div class="row">
        <div class="col-12">
            <div class="col-12 text-center mt-50">
                <img src="<?= Yii::$app->homeUrl ?>image/1.png" class="width-dashboard">
            </div>
            <div class="col-12 index-Dashboard text-center mt-20">
                Welcome to HRVC Portal
            </div>
            <div class="col-lg-12 text-center title-Dashboard-Welcome">
                Select a module to start using HRVC services, all modules are not available for using to
                every member of Tokyo Consulting Group. modules are given access based on the authority and
                hierarchy of
                the
                personal
            </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-4 card card-Dashboard">
            ...
            <a href="#" class="no-underline">
                <p class="title-KPI"> Lower Management System (LMS) <i class="fa fa-chevron-right" aria-hidden="true"></i></p>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-4 card card-Dashboard">
            <img src="<?= Yii::$app->homeUrl ?>image/6.png" class="width-risk">
            <a href="#" class="no-underline">
                <p class="title-KPI"> Middle Management System MMS <i class="fa fa-chevron-right" aria-hidden="true"></i></p>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-3 col-4 card card-Dashboard">
