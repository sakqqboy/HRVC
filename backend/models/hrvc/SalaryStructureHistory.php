...
use Yii;
use \backend\models\hrvc\master\SalaryStructureHistoryMaster;
...
class SalaryStructureHistory extends \backend\models\hrvc\master\SalaryStructureHistoryMaster{
    /**
    * @inheritdoc
    */
